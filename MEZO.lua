...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./TheMEZO
done
]])
Run:close()
...
HELPBEVQ = Redis:sismember(TheMEZO.."HELPBEVQ:Groups",UserId) 
...
ktmall = Redis:sismember(TheMEZO.."ktmAll:Groups",UserId) ,
...
JoinChannel = true
local Channel = Redis:get(TheMEZO..'Channel:Join')
if Channel then
...
local Numbardel = Redis:get(TheMEZO.."allM:numdel"..msg.chat_id) or 200
...
elseif Redis:sismember(TheMEZO.."HELPBEVQ:Groups",msg.sender.user_id) == true then
...
if text and Redis:get(TheMEZO..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(TheMEZO..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(TheMEZO..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
local N = (Redis:get(TheMEZO.."Name:Bot") or "كلير")
...
if (Redis:get(TheMEZO..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
...
Redis:set(TheMEZO..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(TheMEZO..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
...
Redis:del(TheMEZO..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(TheMEZO..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
...
if text and Redis:get(TheMEZO.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheMEZO.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(TheMEZO.."All:Get:Reides:Commands:Group"..text)
Redis:del(TheMEZO.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheMEZO.."All:Command:List:Group",text)
...
Redis:del(TheMEZO.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheMEZO.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheMEZO.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheMEZO.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheMEZO.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheMEZO.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheMEZO.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheMEZO.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(TheMEZO.."All:Command:List:Group",text)
Redis:del(TheMEZO.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
...
Redis:set(TheMEZO.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
...
Redis:set(TheMEZO.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(TheMEZO.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
Redis:del(TheMEZO.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheMEZO.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
...
Redis:del(TheMEZO.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= TheMEZO then
...
Redis:set(TheMEZO.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
...
Redis:set(TheMEZO.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
...
Redis:set(TheMEZO.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text then
if not Redis:sismember(TheMEZO..'Spam:Group'..msg.sender.user_id,text) then
...
local photoc = Redis:get(TheMEZO.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(TheMEZO.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(TheMEZO.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(TheMEZO.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheMEZO.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(TheMEZO.."Add:Rd:Sudo:Audioc"..text)
...
Redis:sadd(TheMEZO.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
local photoc = Redis:get(TheMEZO.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(TheMEZO.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(TheMEZO.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
...
local audioc = Redis:get(TheMEZO.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(TheMEZO..'GetTexting:DevTheMEZO'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(TheMEZO..'GetTexting:DevTheMEZO'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم الغاء حفظ كليشة المطور')
end
Redis:set(TheMEZO..'Texting:DevTheMEZO',text)
Redis:del(TheMEZO..'GetTexting:DevTheMEZO'..msg_chat_id..':'..msg.sender.user_id)
...
Redis:del(TheMEZO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheMEZO.."Set:Id:Groups",text:match("(.*)"))
...
if Redis:get(TheMEZO.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(TheMEZO.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(TheMEZO.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."Game:Countrygof"..msg.chat_id)
...
if text then
local NewCmmd = Redis:get(TheMEZO.."All:Get:Reides:Commands:Group"..text) or Redis:get(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
Y = Y + 1
Redis:sadd(TheMEZO..'Num:User:Pv',v)  
end
X = 0
...
os.execute('rm -rf TheMEZO.lua')
os.execute('wget https://adfrv.zzz.com.ua/beb/TheMEZO.lua')
...
if (Redis:get(TheMEZO..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(TheMEZO..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,TheMEZO).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(TheMEZO..'Channel:Join',ChannelUser) 
...
Redis:set(TheMEZO..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:del(TheMEZO..'Channel:Join')
...
Redis:set(TheMEZO..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*𖥔 عدد احصائيات البوت الكامله \n⩹━━━━𖥕TheMEZO𖥕━━━━⩺\n𖥔 عدد المجموعات : '..(Redis:scard(TheMEZO..'ChekBotAdd') or 0)..'\n𖥔 عدد المشتركين : '..(Redis:scard(TheMEZO..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(TheMEZO..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(TheMEZO..'Num:Add:Bot'),"md",true)  
end
...
Redis:set(TheMEZO.."allM:numdel"..msg.chat_id,Numbardel) 
...
if not Redis:sismember(TheMEZO.."DevelopersQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."DevelopersQ:Groups",bana.id) 
...
if not Redis:sismember(TheMEZO.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(TheMEZO.."HELPBEVQ:Groups")
Redis:del(TheMEZO.."HELPBEVQ:Groups", bana.id)
Redis:del(TheMEZO.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(TheMEZO.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Developers:Groups",bana.id) 
...
if not Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(TheMEZO.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(TheMEZO.."HELPBEVQ:Groups")
Redis:del(TheMEZO.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(TheMEZO.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(TheMEZO.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(TheMEZO.."HELPBEVQ:Groups")
Redis:del(TheMEZO.."HELPBEVQ:Groups", UserId)
Redis:del(TheMEZO.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(TheMEZO.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(TheMEZO.."HELPBEVQ:Groups")
Redis:sadd(TheMEZO.."HELPBEVQ:Groups", UserId)
Redis:set(TheMEZO.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(TheMEZO.."Developers:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Developers:Groups",bana.id) 
...
if Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Managers:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(TheMEZO.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(TheMEZO.."HELPBEVQ:Groups")
Redis:sadd(TheMEZO.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(TheMEZO.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(TheMEZO.."HELPBEVQ:Groups",UserId) then
...
Redis:set(TheMEZO.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:del(TheMEZO.."PresidentQ:Group:Reply"..msg.chat_id)
...
local Info_Members = Redis:smembers(TheMEZO.."ktmAll:Groups") 
if #Info_Members == 0 then
...
if TextMsg == 'التحقق' then
    Redis:set(TheMEZO.."Status:joinet"..msg_chat_id,true) 
...
if TextMsg == 'التحقق' then
    Redis:del(TheMEZO.."Status:joinet"..msg_chat_id) 
...
if text == "نزلني" then
if not Redis:get(TheMEZO.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(TheMEZO.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheMEZO.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(TheMEZO.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(TheMEZO.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
...
if photo.total_count > 0 then
local TestText = "  ❲ TheMEZO  Source ❳\n— — — — — — — — —\n 𖥔*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n𖥔 *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< Developers TheMEZO  >', url = "https://t.me/Q_o_ll"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
local id = Redis:get(TheMEZO.."id:HELPBEVQ:Groups")
...
local Added_Me = Redis:get(TheMEZO.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
Redis:sadd(TheMEZO.."cleaner"..msg_chat_id,msg_id)
end
if text == "مسح الميديا" then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص⦗ '..Controller_Num(6)..' ⦘* ',"md",true)  
end
local list = Redis:smembers(TheMEZO.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(TheMEZO.."cleaner"..msg_chat_id)
...
Redis:set(TheMEZO.."lockalllll"..msg_chat_id,"off")
...
Redis:set(TheMEZO.."lockalllll"..msg_chat_id,"on")
...
Redis:set(TheMEZO..''..lock..msg_chat_id,"del")    
end
...
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(TheMEZO..''..lock..msg_chat_id)    
end
...
Redis:set(TheMEZO..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(TheMEZO..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(TheMEZO..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(TheMEZO..'lock:Fshar'..msg.chat_id) 
...
Redis:del(TheMEZO..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم فتح السب").unLock,"md",true)  
end
...
Redis:del(TheMEZO..'lock:Fars'..msg.chat_id) 
...
Redis:set(TheMEZO..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(TheMEZO..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(TheMEZO.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheMEZO.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheMEZO.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(TheMEZO.."All:Get:Reides:Commands:Group"..v)
Redis:del(TheMEZO.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheMEZO.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
{
{text = 'اتعطيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:bna_ban'},{text = 'اتفعيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:bna_TheMEZO'},
},
{
...
Rink = 1
elseif Redis:sismember(TheMEZO.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheMEZO.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
...
Rink = 1
elseif Redis:sismember(TheMEZO.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(TheMEZO.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(TheMEZO.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(TheMEZO.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(TheMEZO.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(TheMEZO.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(TheMEZO.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(TheMEZO.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(TheMEZO..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(TheMEZO..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(TheMEZO..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد رسائلك هنا *~ '..(Redis:get(TheMEZO..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد التعديلات هنا *~ '..(Redis:get(TheMEZO..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد جهاتك المضافه هنا *~ '..(Redis:get(TheMEZO.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheMEZO.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
...
Redis:del(TheMEZO.."ktmAll:Groups") 
...
if text and not Redis:sismember(TheMEZO.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(TheMEZO.."Spam:Group"..msg.sender.user_id) 
end
...
Redis:del(TheMEZO.."Add:Rd:Sudo:Photoc"..v)
...
if not msg.ControllerBot and not Redis:set(TheMEZO.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(TheMEZO..'Channel:Join')}, },}}
...
BanAll = 'محظور عام ,'
Redis:srem(TheMEZO.."BanAll:Groups",bana.id) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,bana.id).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(TheMEZO.."BanGroup:Group"..msg_chat_id,bana.id) 
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,bana.id).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(TheMEZO.."SilentGroup:Group"..msg_chat_id,bana.id) 
else
SilentGroup = ''
end
LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 تم رفع القيود عنه : {"..BanAll..BanGroup..SilentGroup..Restricted..'}*',"md",true)  
...
Redis:set(TheMEZO..'GetTexting:DevTheMEZO'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:del(TheMEZO..'Texting:DevTheMEZO')
...
local ban = LuaTele.getUser(TheMEZO)
local Namebot = (Redis:get(TheMEZO.."Name:Bot") or "كلير")
local BotName = {
...
if text == (Redis:get(TheMEZO.."Name:Bot") or "كلير") then
local photo = LuaTele.getUserProfilePhotos(TheMEZO)
local ban = LuaTele.getUser(TheMEZO)
local Namebot = (Redis:get(TheMEZO.."Name:Bot") or "كلير")
local BotName = {
...
x = x + 1
Redis:srem(TheMEZO..'Num:User:Pv',v)
end
end
if x ~= 0 then
...
Redis:srem(TheMEZO..'ChekBotAdd',Get_Chat.id)
...
Redis:srem(TheMEZO..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
if Redis:get(TheMEZO.."Status:Games"..msg.chat_id) then
Redis:del(TheMEZO.."Set:Country"..msg.chat_id)
...
Redis:set(TheMEZO.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(TheMEZO.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
...
local ban = LuaTele.getUser(TheMEZO)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(TheMEZO..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(TheMEZO.."Start:Bot") then
...
local CmdStart = '*\n𖥔 أهلآ بك في بوت '..(Redis:get(TheMEZO.."Name:Bot") or "كلير")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheMEZO.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
keyboardd.inline_keyboard = {
{
{text = '< Developers TheMEZO  >', url = "https://t.me/M_P_L_6"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '< Developers TheMEZO  >', url = "https://t.me/BoOdY_BaSha"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
Redis:del(TheMEZO.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(TheMEZO.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if tonumber(data.message.sender.user_id) == tonumber(TheMEZO) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(TheMEZO..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
Redis:incr(TheMEZO..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
...
Redis:set(TheMEZO.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(TheMEZO.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."AddSudosNew"..ChatId)
...
local reply_markup = LuaTele.replyMarkup{type = '