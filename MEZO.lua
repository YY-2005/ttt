...
Status = 0
Developers = Redis:sismember(TheMEZO.."MEZO:Developers:Groups",UserId) 
DevelopersQ = Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",UserId) 
TheBasics = Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..ChatId,UserId) 
Originators = Redis:sismember(TheMEZO.."MEZO:Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(TheMEZO.."MEZO:Managers:Group"..ChatId,UserId)
...
Status = Redis:get(TheMEZO.."MEZO:Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasics then
Status = Redis:get(TheMEZO.."MEZO:President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(TheMEZO.."MEZO:Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(TheMEZO.."MEZO:Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(TheMEZO.."MEZO:Admin:Group:Reply"..ChatId) or 'الادمن'
elseif StatusMember == "chatMemberStatusCreator" then
Status = 'مالك المجموعه'
elseif StatusMember == "chatMemberStatusAdministrator" then
Status = 'ادمن المجموعه'
elseif Distinguished then
Status = Redis:get(TheMEZO.."MEZO:Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(TheMEZO.."MEZO:Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(TheMEZO.."MEZO:lockpin"..ChatId) then    
lock_pin = "✔️"
else 
lock_pin = "❌"    
end
if Redis:get(TheMEZO.."MEZO:Lock:tagservr"..ChatId) then    
lock_tagservr = "✔️"
else 
lock_tagservr = "❌"
end
if Redis:get(TheMEZO.."MEZO:Lock:text"..ChatId) then    
lock_text = "✔️"
else 
lock_text = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✔️"
else 
lock_add = "❌ "    
end    
if Redis:get(TheMEZO.."MEZO:Lock:Join"..ChatId) == "kick" then
lock_join = "✔️"
else 
lock_join = "❌ "    
end    
if Redis:get(TheMEZO.."MEZO:Lock:edit"..ChatId) then    
lock_edit = "✔️"
else 
lock_edit = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Chek:Welcome"..ChatId) then
welcome = "✔️"
else 
welcome = "❌ "    
end
if Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✔️"
else     
flood = "❌ "     
end
if Redis:get(TheMEZO.."MEZO:Lock:Photo"..ChatId) == "del" then
lock_photo = "✔️" 
elseif Redis:get(TheMEZO.."MEZO:Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(TheMEZO.."MEZO:Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❌ "   
end    
if Redis:get(TheMEZO.."MEZO:Lock:Contact"..ChatId) == "del" then
lock_phon = "✔️" 
elseif Redis:get(TheMEZO.."MEZO:Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❌ "    
end    
if Redis:get(TheMEZO.."MEZO:Lock:Link"..ChatId) == "del" then
lock_links = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(TheMEZO.."MEZO:Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:User:Name"..ChatId) == "del" then
lock_user = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:hashtak"..ChatId) == "del" then
lock_hash = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:vico"..ChatId) == "del" then
lock_muse = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❌ "    
end 
if Redis:get(TheMEZO.."MEZO:Lock:Video"..ChatId) == "del" then
lock_ved = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:Animation"..ChatId) == "del" then
lock_gif = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:Sticker"..ChatId) == "del" then
lock_ste = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:geam"..ChatId) == "del" then
lock_geam = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❌ "    
end    
...
if Redis:get(TheMEZO.."MEZO:Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(TheMEZO.."MEZO:Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❌ "
end
if Redis:get(TheMEZO.."MEZO:Lock:forward"..ChatId) == "del" then
lock_fwd = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❌ "    
end    
if Redis:get(TheMEZO.."MEZO:Lock:Document"..ChatId) == "del" then
lock_file = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❌ "    
end    
if Redis:get(TheMEZO.."MEZO:Lock:Unsupported"..ChatId) == "del" then
lock_self = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(TheMEZO.."MEZO:Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❌ "    
end
if Redis:get(TheMEZO.."MEZO:Lock:Spam"..ChatId) == "del" then    
lock_spam = "✔️"
elseif Redis:get(TheMEZO.."MEZO:Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(TheMEZO.."MEZO:Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❌ "    
end        
...
return{
BanAll = Redis:sismember(TheMEZO.."MEZO:BanAll:Groups",UserId) ,
BanGroup = Redis:sismember(TheMEZO.."MEZO:BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(TheMEZO.."MEZO:SilentGroup:Group"..ChatId,UserId)
}
end
...
elseif Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(TheMEZO.."MEZO:Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(TheMEZO.."MEZO:Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(TheMEZO.."MEZO:President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي ⭐'
elseif Redis:sismember(TheMEZO.."MEZO:Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(TheMEZO.."MEZO:Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(TheMEZO.."MEZO:Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(TheMEZO.."MEZO:Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(TheMEZO.."MEZO:Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(TheMEZO.."MEZO:Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(TheMEZO.."MEZO:Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(TheMEZO.."MEZO:Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(TheMEZO) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(TheMEZO.."MEZO:Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(TheMEZO.."MEZO:Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheMEZO.."MEZO:Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(TheMEZO.."MEZO:Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(TheMEZO) then
return false
end
local floods = Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_MEZO = Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(TheMEZO.."MEZO:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(TheMEZO.."MEZO:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(TheMEZO.."MEZO:Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_MEZO = 5
if Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_MEZO = Redis:hget(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
...
sens = 400  
if Redis:get(TheMEZO.."MEZO:Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMEZO.."MEZO:Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMEZO.."MEZO:Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(TheMEZO.."MEZO:Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(TheMEZO.."MEZO:SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Distinguished then -- التوجيه
local Fwd_Group = Redis:get(TheMEZO.."MEZO:Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(TheMEZO.."MEZO:Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(TheMEZO.."MEZO:Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(TheMEZO.."MEZO:Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(TheMEZO.."MEZO:lockpin"..msg_chat_id)
...
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(TheMEZO.."MEZO:Lock:Join"..msg.chat_id) == "kick" then
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end
...
Redis:incr(TheMEZO.."MEZO:Num:Add:Memp"..msg_chat_id..":"..msg.sender.user_id) 
local AddMembrs = Redis:get(TheMEZO.."MEZO:Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(TheMEZO.."MEZO:Lock:Bot:kick"..msg_chat_id)
...
Redis:incr(TheMEZO.."MEZO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(TheMEZO.."MEZO:Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(TheMEZO.."MEZO:Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(TheMEZO.."MEZO:Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(TheMEZO.."MEZO:Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(TheMEZO.."MEZO:Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(TheMEZO.."MEZO:Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(TheMEZO.."MEZO:Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(TheMEZO.."MEZO:Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(TheMEZO.."MEZO:Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(TheMEZO.."MEZO:Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(TheMEZO.."MEZO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
local ChatPhoto = LuaTele.setChatPhoto(msg_chat_id,msg.content.photo.sizes[2].photo.remote.id)
if (ChatPhoto.luatele == "error") then
Redis:del(TheMEZO.."MEZO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(TheMEZO.."MEZO:Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(TheMEZO.."MEZO:Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(TheMEZO.."MEZO:Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(TheMEZO.."MEZO:Lock:Cmd"..msg_chat_id)
...
Filters = 'صوره'
Redis:sadd(TheMEZO.."MEZO:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(TheMEZO.."MEZO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(TheMEZO.."MEZO:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(TheMEZO.."MEZO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(TheMEZO.."MEZO:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(TheMEZO.."MEZO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(TheMEZO.."MEZO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(TheMEZO.."MEZO:List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
...
local Text_Filter = Redis:get(TheMEZO.."MEZO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(TheMEZO.."MEZO:Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(TheMEZO.."MEZO:Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
...
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(TheMEZO.."MEZO:List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(TheMEZO.."MEZO:Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(TheMEZO.."MEZO:List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(TheMEZO.."MEZO:Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(TheMEZO.."MEZO:List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(TheMEZO.."MEZO:Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(TheMEZO.."MEZO:List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(TheMEZO.."MEZO:Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(TheMEZO..'MEZO:FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(TheMEZO.."MEZO:Filter:Group:"..DelFilters..msg_chat_id)
...
if text and Redis:get(TheMEZO.."MEZO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(TheMEZO.."MEZO:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(TheMEZO.."MEZO:Command:List:Group"..msg_chat_id,text)
...
Redis:del(TheMEZO.."MEZO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(TheMEZO.."MEZO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(TheMEZO.."MEZO:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(TheMEZO.."MEZO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(TheMEZO.."MEZO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(TheMEZO.."MEZO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(TheMEZO.."MEZO:Command:Reids:Group:New"..msg_chat_id)
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(TheMEZO.."MEZO:Command:List:Group"..msg_chat_id,text)
Redis:del(TheMEZO.."MEZO:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(TheMEZO.."MEZO:Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(TheMEZO.."MEZO:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(TheMEZO.."MEZO:Group:Link"..msg_chat_id,LinkGroup)
Redis:del(TheMEZO.."MEZO:Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:del(TheMEZO.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(TheMEZO.."MEZO:Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ ترحيب المجموعه","md",true)     
end
if Redis:get(TheMEZO.."MEZO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheMEZO.."MEZO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(TheMEZO.."MEZO:Group:Rules" .. msg_chat_id,text) 
Redis:del(TheMEZO.."MEZO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ قوانين المجموعه","md",true)  
end  
if Redis:get(TheMEZO.."MEZO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(TheMEZO.."MEZO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
local test = Redis:get(TheMEZO.."MEZO:Text:Manager"..msg.sender.user_id..":"..msg_chat_id.."")
if Redis:get(TheMEZO.."MEZO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheMEZO.."MEZO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
end   
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Text"..test..msg_chat_id, text)  
end  
if msg.content.audio then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
end
if msg.content.animation then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
end
if msg.content.video_note then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.video then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
end
if msg.content.photo then
...
print(idPhoto)
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
end
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حفظ رد للمدير بنجاح \n◍ ارسل ( "..test.." ) لرئية الرد","md",true)  
end  
end
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."MEZO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheMEZO.."MEZO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(TheMEZO.."MEZO:Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:sadd(TheMEZO.."MEZO:List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."MEZO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheMEZO.."MEZO:List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"◍ تم حذف الرد من ردود المدير ","md",true)  
return false
end
end
if text and Redis:get(TheMEZO.."MEZO:Status:ReplySudo"..msg_chat_id) then
local anemi = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Photo"..text)
local video = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Video"..text)
local document = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:File"..text)
local audio = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Audio"..text)
local video_note = Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
if text and Redis:get(TheMEZO.."MEZO:Status:Reply"..msg_chat_id) then
local anemi = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Photo"..text..msg_chat_id)
local video = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Video"..text..msg_chat_id)
local document = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Audio"..text..msg_chat_id)
local video_note = Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(TheMEZO..'MEZO:Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(TheMEZO.."MEZO:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(TheMEZO.."MEZO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(TheMEZO.."MEZO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if msg.content.sticker then   
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
end   
if msg.content.voice_note then  
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
end   
if msg.content.animation then   
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
end  
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:Text"..test, text)  
end  
if msg.content.audio then
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
end
if msg.content.document then
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
end
if msg.content.video then
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
end
if msg.content.video_note then
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
end
if msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
Redis:set(TheMEZO.."MEZO:Add:Rd:Sudo:Photo"..test, idPhoto)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."MEZO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(TheMEZO.."MEZO:Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(TheMEZO.."MEZO:Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(TheMEZO.."MEZO:List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(TheMEZO.."MEZO:Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
Redis:del(TheMEZO.."MEZO:Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(TheMEZO.."MEZO:List:Rd:Sudo", text)
...
local list = Redis:smembers(TheMEZO.."MEZO:ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v,0,text,"md",true)
Redis:set(TheMEZO.."MEZO:PinMsegees:"..v,text)
end
end
...
if Redis:get(TheMEZO.."MEZO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n◍ تم الغاء امر تعين الايدي","md",true)  
Redis:del(TheMEZO.."MEZO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(TheMEZO.."MEZO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(TheMEZO.."MEZO:Set:Id:Group"..msg.chat_id,text:match("(.*)"))
...
Redis:del(TheMEZO.."MEZO:Change:Name:Bot"..msg.sender.user_id) 
Redis:set(TheMEZO.."MEZO:Name:Bot",text) 
...
Redis:del(TheMEZO.."MEZO:Change:Start:Bot"..msg.sender.user_id) 
Redis:set(TheMEZO.."MEZO:Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "◍  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(TheMEZO.."MEZO:Game:Smile"..msg.chat_id) then
if text == Redis:get(TheMEZO.."MEZO:Game:Smile"..msg.chat_id) then
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."MEZO:Game:Smile"..msg.chat_id)
...
if Redis:get(TheMEZO.."MEZO:Game:Monotonous"..msg.chat_id) then
if text == Redis:get(TheMEZO.."MEZO:Game:Monotonous"..msg.chat_id) then
Redis:del(TheMEZO.."MEZO:Game:Monotonous"..msg.chat_id)
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheMEZO.."MEZO:Game:Riddles"..msg.chat_id) then
if text == Redis:get(TheMEZO.."MEZO:Game:Riddles"..msg.chat_id) then
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."MEZO:Game:Riddles"..msg.chat_id)
...
if Redis:get(TheMEZO.."MEZO:Game:Meaningof"..msg.chat_id) then
if text == Redis:get(TheMEZO.."MEZO:Game:Meaningof"..msg.chat_id) then
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."MEZO:Game:Meaningof"..msg.chat_id)
...
if Redis:get(TheMEZO.."MEZO:Game:Reflection"..msg.chat_id) then
if text == Redis:get(TheMEZO.."MEZO:Game:Reflection"..msg.chat_id) then
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(TheMEZO.."MEZO:Game:Reflection"..msg.chat_id)
...
if Redis:get(TheMEZO.."MEZO:Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(TheMEZO.."MEZO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(TheMEZO.."MEZO:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMEZO.."MEZO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"◍ مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(TheMEZO.."MEZO:SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(TheMEZO.."MEZO:SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(TheMEZO.."MEZO:SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(TheMEZO.."MEZO:Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(TheMEZO.."MEZO:Game:Difference"..msg.chat_id) then
if text == Redis:get(TheMEZO.."MEZO:Game:Difference"..msg.chat_id) then 
Redis:del(TheMEZO.."MEZO:Game:Difference"..msg.chat_id)
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(TheMEZO.."MEZO:Game:Example"..msg.chat_id) then
if text == Redis:get(TheMEZO.."MEZO:Game:Example"..msg.chat_id) then 
Redis:del(TheMEZO.."MEZO:Game:Example"..msg.chat_id)
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
X = X + 1
Redis:sadd(TheMEZO.."MEZO:ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(TheMEZO.."MEZO:TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(TheMEZO.."MEZO:Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(TheMEZO.."MEZO:Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(TheMEZO.."MEZO:Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(TheMEZO.."MEZO:Distinguished:Group"..GroupId,v)
end
end 
end
...
Redis:sadd(TheMEZO.."MEZO:ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(TheMEZO.."MEZO:Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(TheMEZO.."MEZO:Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(TheMEZO.."MEZO:Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(TheMEZO.."MEZO:TheBasics:Group"..idg,idASAS)
end;end
end
...
if (Redis:get(TheMEZO.."MEZO:AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == '『 الغاء الامر 』' then   
Redis:del(TheMEZO.."MEZO:AddSudosNew"..msg_chat_id)
...
Redis:set(TheMEZO.."MEZO:AddSudosNew"..msg_chat_id,true)
...
local UsersBot = Redis:smembers(TheMEZO..'MEZO:Num:User:Pv')  
...
local President = Redis:smembers(TheMEZO.."MEZO:TheBasics:Group"..v)
local Constructor = Redis:smembers(TheMEZO.."MEZO:Originators:Group"..v)
local Manager = Redis:smembers(TheMEZO.."MEZO:Managers:Group"..v)
local Admin = Redis:smembers(TheMEZO.."MEZO:Addictive:Group"..v)
local Vips = Redis:smembers(TheMEZO.."MEZO:Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
listrep = Redis:smembers(TheMEZO.."MEZO:List:Manager"..ide.."")
if k == 1 then
...
if Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..v..ide) then
db = "gif@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..v..ide)
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..v..ide) then
db = "Vico@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..v..ide)
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..v..ide) then
db = "Stekrs@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..v..ide)
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Text"..v..ide) then
db = "Text@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Text"..v..ide)
db = string.gsub(db,'"','')
db = string.gsub(db,"'",'')
db = string.gsub(db,'*','')
db = string.gsub(db,'`','')
...
db = string.gsub(db,'}','')
db = string.gsub(db,'\n',' ')
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Photo"..v..ide) then
db = "Photo@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Photo"..v..ide) 
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Video"..v..ide) then
db = "Video@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Video"..v..ide)
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:File"..v..ide) then
db = "File@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:File"..v..ide)
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Audio"..v..ide) then
db = "Audio@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Audio"..v..ide)
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..v..ide) then
db = "video_note@"..Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..v..ide)
end
v = string.gsub(v,'"','')
v = string.gsub(v,"'",'')
...
Redis:sadd(TheMEZO.."MEZO:List:Manager"..GroupId,k)
if v and v:match('gif@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..k..GroupId,v:match('gif@(.*)'))
elseif v and v:match('Vico@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..k..GroupId,v:match('Vico@(.*)'))
elseif v and v:match('Stekrs@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..k..GroupId,v:match('Stekrs@(.*)'))
elseif v and v:match('Text@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Text"..k..GroupId,v:match('Text@(.*)'))
elseif v and v:match('Photo@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Photo"..k..GroupId,v:match('Photo@(.*)'))
elseif v and v:match('Video@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Video"..k..GroupId,v:match('Video@(.*)'))
elseif v and v:match('File@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:File"..k..GroupId,v:match('File@(.*)') )
elseif v and v:match('Audio@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:Audio"..k..GroupId,v:match('Audio@(.*)'))
elseif v and v:match('video_note@(.*)') then
Redis:set(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..k..GroupId,v:match('video_note@(.*)') )
end
end
end
end
...
Groups = (Redis:scard(TheMEZO..'MEZO:ChekBotAdd') or 0)
Users = (Redis:scard(TheMEZO..'MEZO:Num:User:Pv') or 0)
if photo.total_count > 0 then
local MEZOa = 'احصائيات الـــبوت'
...
https.request("https://api.telegram.org/bot"..Token.."/sendphoto?chat_id=" .. msg_chat_id .. "&photo="..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id.."&photo=".. URL.escape(MEZOa).."&reply_to_message_id="..msgg.."&parse_mode=markdown&disable_web_page_preview=true&reply_markup="..JSON.encode(keyboard))
end
end
...
if Redis:sismember(TheMEZO.."MEZO:ChekBotAdd",msg_chat_id) then
...
Redis:sadd(TheMEZO.."MEZO:ChekBotAdd",msg_chat_id)
Redis:set(TheMEZO.."MEZO:Status:Id"..msg_chat_id,true) ;Redis:set(TheMEZO.."MEZO:Status:Reply"..msg_chat_id,true) ;Redis:set(TheMEZO.."MEZO:Status:ReplySudo"..msg_chat_id,true) ;Redis:set(TheMEZO.."MEZO:Status:BanId"..msg_chat_id,true) ;Redis:set(TheMEZO.."MEZO:Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(TheMEZO.."MEZO:BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(TheMEZO.."MEZO:ChekBotAdd",msg_chat_id) then
...
Redis:srem(TheMEZO.."MEZO:ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(TheMEZO.."MEZO:ChekBotAdd",msg_chat_id) then
...
if not Redis:get(TheMEZO.."MEZO:Status:Id"..msg_chat_id) then
return false
end
local UserInfo = LuaTele.getUser(msg.sender.user_id)
...
local NumberGames = Redis:get(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(TheMEZO.."MEZO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(TheMEZO.."MEZO:Set:Id:Group"..msg_chat_id)
if Redis:get(TheMEZO.."MEZO:Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
return LuaTele.sendText(msg_chat_id,msg_id,Get_Is_Id,"md") 
end
else
if photo.total_count > 0 then
...
local TotalMsg = Redis:get(TheMEZO..'MEZO:Num:Message:User'..msg_chat_id..':'..Message_Reply.sender.user_id) or 0
local TotalEdit = Redis:get(TheMEZO..'MEZO:Num:Message:Edit'..msg_chat_id..Message_Reply.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*◍ ايديه : '..UserId..
...
local TotalMsg = Redis:get(TheMEZO..'MEZO:Num:Message:User'..msg_chat_id..':'..Useriid_Info.id) or 0
local TotalEdit = Redis:get(TheMEZO..'MEZO:Num:Message:Edit'..msg_chat_id..Useriid_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*◍ ايديه : '..Useriid..
'\n◍ معرفه : '..UserInfousername..
...
local TotalMsg = Redis:get(TheMEZO..'MEZO:Num:Message:User'..msg_chat_id..':'..UserId_Info.id) or 0
local TotalEdit = Redis:get(TheMEZO..'MEZO:Num:Message:Edit'..msg_chat_id..UserId_Info.id) or 0
local TotalMsgT = Total_message(TotalMsg) 
return LuaTele.sendText(msg_chat_id,msg_id,
'\n*⌔︙ايديه : '..UserId..
'\n⌔︙معرفه : @'..UserName..
...
if not Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:DevelopersQ:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Developers:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم تنزيله مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:DevelopersQ:Groups",UserId) 
...
if not Redis:sismember(TheMEZO.."MEZO:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم تنزيله مطور مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Developers:Groups",UserId) 
...
if not Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:DevelopersQ:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."MEZO:Developers:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:Developers:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheMEZO.."MEZO:Status:SetId"..msg_chat_id) then
...
Redis:sadd(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,UserId_Info.id) 
...
Redis:sadd(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."MEZO:DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."MEZO:Developers:Groups",Message_Reply.sender.user_id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:sadd(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:sadd(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:sadd(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
Redis:sadd(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:DevelopersQ:Groups",UserId) 
...
if Redis:sismember(TheMEZO.."MEZO:Developers:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم ترقيته مطور مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:Developers:Groups",UserId) 
...
if Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"◍ تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(TheMEZO.."MEZO:Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMEZO.."MEZO:President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMEZO.."MEZO:Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMEZO.."MEZO:Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(TheMEZO.."MEZO:Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(TheMEZO.."MEZO:Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ لا يوجد مطورين حاليا , ","md",true)  
end
ListMembers = '\n*◍ قائمه مطورين البوت \n — — — — — — — — —*\n'
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(TheMEZO.."MEZO:Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(TheMEZO.."MEZO:Status:Welcome"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Status:Id"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Status:Reply"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Status:BanId"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Sasa:Jeka"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"* ◉ تم تفعيل ردود السورس *","md",true)
end
if TextMsg == 'نزلني' then
Redis:set(TheMEZO.."MEZO:Status:remMe"..msg_chat_id,true) 
...
Redis:sadd(TheMEZO.."MEZO:allM"..msg.chat_id, msg.id)
if Redis:get(TheMEZO.."MEZO:Status:Del:Media"..msg.chat_id) then    
local gmedia = Redis:scard(TheMEZO.."MEZO:allM"..msg.chat_id)  
if gmedia >= 200 then
local liste = Redis:smembers(TheMEZO.."MEZO:allM"..msg.chat_id)
...
Redis:del(TheMEZO.."MEZO:allM"..msg.chat_id)
end
end
end
...
local list = Redis:smembers(TheMEZO.."MEZO:allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
Redis:del(TheMEZO.."MEZO:Status:Del:Media"..msg.chat_id)
...
Redis:set(TheMEZO.."MEZO:Status:Del:Media"..msg.chat_id,true)
...
Redis:del(TheMEZO.."MEZO:Status:yt"..msg.chat_id)
...
Redis:set(TheMEZO.."MEZO:Status:yt"..msg.chat_id,true)
LuaTele.sendText(msg_chat_id,msg_id,'◍ تم تفعيل اليوتيوب')
return false
end 
if text and text:match('^بحث (.*)$') and Redis:get(TheMEZO.."MEZO:Status:yt"..msg.chat_id) then
...
if TextMsg == 'الرابط' then
Redis:del(TheMEZO.."MEZO:Status:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:del(TheMEZO.."MEZO:Status:Welcome"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Status:Id"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Status:IdPhoto"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Status:Reply"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Status:ReplySudo"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Status:BanId"..msg_chat_id) 
...
if TextMsg == 'ردود السورس' then
Redis:del(TheMEZO.."MEZO:Sasa:Jeka"..msg_chat_id) 
...
if Redis:sismember(TheMEZO.."MEZO:BanAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم حظره عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:BanAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:BanAll:Groups",UserId_Info.id) then
...
Redis:srem(TheMEZO.."MEZO:BanAll:Groups",UserId_Info.id) 
...
if Redis:sismember(TheMEZO.."MEZO:ktmAll:Groups",UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id," ◉ تم كتمه عام من المجموعات مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:ktmAll:Groups",UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:ktmAll:Groups",UserId_Info.id) then
...
Redis:srem(TheMEZO.."MEZO:ktmAll:Groups",UserId_Info.id) 
...
if not msg.Originators and not Redis:get(TheMEZO.."MEZO:Status:BanId"..msg_chat_id) then
...
if Redis:sismember(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'banned',0)
...
if not Redis:sismember(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId_Info.id) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId_Info.id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
...
if not Redis:sismember(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,UserId_Info.id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId_Info.id,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheMEZO.."MEZO:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."MEZO:BanAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:BanAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:BanAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."MEZO:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."MEZO:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:ktmAll:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:ktmAll:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'banned',0)
...
if not Redis:sismember(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
LuaTele.setChatMemberStatus(msg.chat_id,Message_Reply.sender.user_id,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(Message_Reply.sender.user_id,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if Redis:sismember(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'banned',0)
...
if not Redis:sismember(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء حظره من المجموعه مسبقا ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id,UserId) 
LuaTele.setChatMemberStatus(msg.chat_id,UserId,'restricted',{1,1,1,1,1,1,1,1,1})
...
if Redis:sismember(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم كتمه في المجموعه مسبقا ").Reply,"md",true)  
else
Redis:sadd(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,UserId) 
...
if not Redis:sismember(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
else
Redis:srem(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id,UserId) 
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"◍ تم الغاء كتمه من المجموعه ").Reply,"md",true)  
end
end
...
if text == "نزلني" then
if not Redis:get(TheMEZO.."MEZO:Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(TheMEZO.."MEZO:DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheMEZO.."MEZO:Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(TheMEZO.."MEZO:TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheMEZO.."MEZO:Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheMEZO.."MEZO:Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id," ◉ تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "اطردنى" then
if not Redis:get(TheMEZO.."MEZO:Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheMEZO.."MEZO:chadmin"..msg_chat_id),"md",true)  
end
if text == "اضف قناه" then
if not msg.Addictive then
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ◈ هاذا الامر يخص〘 '..Controller_Num(7)..' 〙* ',"md",true)  
end
Redis:set(TheMEZO.."MEZO:addchannel"..msg.sender.user_id,"on") 
...
if ChannelJoin(msg) == false then
local chinfo = Redis:get(TheMEZO.."MEZO:ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n ◈ عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
Redis:set(TheMEZO.."MEZO:Lock:channell"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Lock:text"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(TheMEZO.."MEZO:Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(TheMEZO.."MEZO:Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(TheMEZO.."MEZO:Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(TheMEZO.."MEZO:lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(TheMEZO.."MEZO:Lock:edit"..msg_chat_id,true) 
...
Redis:set(TheMEZO.."MEZO:Lock:tagservrbot"..msg_chat_id,true)   
...
Redis:del(TheMEZO.."MEZO:Lock:AddMempar"..msg_chat_id)  
...
Redis:del(TheMEZO.."MEZO:Lock:channel"..msg_chat_id)  
...
Redis:del(TheMEZO.."MEZO:Lock:text"..msg_chat_id)  
...
Redis:del(TheMEZO.."MEZO:Lock:Join"..msg_chat_id)  
...
Redis:del(TheMEZO.."MEZO:Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(TheMEZO.."MEZO:Lock:tagservr"..msg_chat_id)  
...
Redis:del(TheMEZO.."MEZO:lockpin"..msg_chat_id)  
...
Redis:del(TheMEZO.."MEZO:Lock:edit"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
...
Redis:hset(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(TheMEZO.."MEZO:Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(TheMEZO.."MEZO:Lock:Link"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Link"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:User:Name"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:hashtak"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Cmd"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Photo"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Video"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Video"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Animation"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:geam"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:geam"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Audio"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:vico"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:vico"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Keyboard"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Sticker"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:forward"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:forward"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Document"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Document"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Unsupported"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Markdaun"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Contact"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Spam"..msg_chat_id)  
...
Redis:set(TheMEZO.."MEZO:Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(TheMEZO.."MEZO:Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(TheMEZO.."MEZO:Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(TheMEZO.."MEZO:Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(TheMEZO.."MEZO:Lock:Inlen"..msg_chat_id)  
...
Redis:setex(TheMEZO.."MEZO:Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:del(TheMEZO.."MEZO:Group:Link"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم مسح الرابط ","md",true)             
end
if text == "الرابط" then
if not Redis:get(TheMEZO.."MEZO:Status:Link"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم تعطيل جلب الرابط من قبل الادمنيه","md",true)
end 
local Get_Chat = LuaTele.getChat(msg_chat_id)
local GetLink = Redis:get(TheMEZO.."MEZO:Group:Link"..msg_chat_id) 
if GetLink then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {
...
if not Redis:get(TheMEZO.."MEZO:Status:Welcome"..msg_chat_id) then
...
Redis:del(TheMEZO.."MEZO:Welcome:Group"..msg_chat_id) 
...
Redis:setex(TheMEZO.."MEZO:Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(TheMEZO.."MEZO:Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"◍ تم ازالة قوانين المجموعه","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(TheMEZO.."MEZO:Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(TheMEZO.."MEZO:Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(TheMEZO.."MEZO:Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(TheMEZO.."MEZO:List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(TheMEZO.."MEZO:Filter:Group:"..v..msg_chat_id)  
Redis:srem(TheMEZO.."MEZO:List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(TheMEZO.."MEZO:Filter:Group:"..v..msg_chat_id)   
...
Redis:set(TheMEZO.."MEZO:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(TheMEZO.."MEZO:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(TheMEZO.."MEZO:Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(TheMEZO.."MEZO:Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
...
if Redis:get(TheMEZO.."MEZO:Status:Link"..msg.chat_id) then
Statuslink = '❬ ✔️ ❭' else Statuslink = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✔️ ❭' else StatusWelcome = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:Id"..msg.chat_id) then
StatusId = '❬ ✔️ ❭' else StatusId = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✔️ ❭' else StatusIdPhoto = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✔️ ❭' else StatusReply = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✔️ ❭' else StatusReplySudo = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✔️ ❭' else StatusBanId = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✔️ ❭' else StatusSetId = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:Games"..msg.chat_id) then
StatusGames = '❬ ✔️ ❭' else StatusGames = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✔️ ❭' else Statuskickme = '❬ ❌ ❭'
end
if Redis:get(TheMEZO.."MEZO:Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(TheMEZO.."MEZO:Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 3
elseif Redis:sismember(TheMEZO.."MEZO:Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(TheMEZO.."MEZO:Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
else
Rink = 8
end
...
Rink = 1
elseif Redis:sismember(TheMEZO.."MEZO:Developers:Groups",UserId_Info.id)  then
Rink = 2
elseif Redis:sismember(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id, UserId_Info.id) then
Rink = 3
elseif Redis:sismember(TheMEZO.."MEZO:Originators:Group"..msg_chat_id, UserId_Info.id) then
Rink = 4
elseif Redis:sismember(TheMEZO.."MEZO:Managers:Group"..msg_chat_id, UserId_Info.id) then
Rink = 5
elseif Redis:sismember(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id, UserId_Info.id) then
Rink = 6
elseif Redis:sismember(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id, UserId_Info.id) then
Rink = 7
else
Rink = 8
end
...
LuaTele.sendText(msg_chat_id,msg_id,'◍ عدد جهاتك المضافه هنا *~ '..(Redis:get(TheMEZO.."MEZO:Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(TheMEZO.."MEZO:Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
◍ ارسل الان النص
◍ يمكنك اضافه :
...
Redis:del(TheMEZO.."MEZO:Set:Id:Group"..msg.chat_id)
...
Redis:del(TheMEZO.."MEZO:TheBasics:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Originators:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Managers:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Addictive:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:Distinguished:Group"..msg_chat_id) 
...
if TextMsg == 'المكتومين عام' or TextMsg == 'قائمه الكتم العام' then
if not msg.ControllerBot then 
return LuaTele.sendText(msg_chat_id,msg_id,'\n* ◉ هاذا الامر يخص 『 '..Controller_Num(1)..' 』* ',"md",true)  
end
if ChannelJoin(msg) == false then
...
Redis:del(TheMEZO.."MEZO:ktmAll:Groups") 
...
Redis:del(TheMEZO.."MEZO:BanGroup:Group"..msg_chat_id) 
...
Redis:del(TheMEZO.."MEZO:SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(TheMEZO.."MEZO:List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(TheMEZO.."MEZO:Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(TheMEZO.."MEZO:List:Manager"..msg_chat_id)
end
...
for k,v in pairs(list) do
if Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف ⌔"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(TheMEZO.."MEZO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(TheMEZO.."MEZO:Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
...
local list = Redis:smembers(TheMEZO.."MEZO:List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:Gif"..v)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:vico"..v)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:stekr"..v)     
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:Text"..v)   
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:Photo"..v)
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:Video"..v)
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:File"..v)
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:Audio"..v)
Redis:del(TheMEZO.."MEZO:Add:Rd:Sudo:video_note"..v)
Redis:del(TheMEZO.."MEZO:List:Rd:Sudo")
end
...
text = "\n📝︙قائمة ردود المطور \n— — — — — — — — —\n"
for k,v in pairs(list) do
if Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(TheMEZO.."MEZO:Add:Rd:Sudo:File"..v) then
db = "ملف ⌔"
...
Redis:setex(TheMEZO.."MEZO:Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMEZO.."MEZO:Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMEZO.."MEZO:Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(TheMEZO.."MEZO:Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(TheMEZO.."MEZO:Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
return LuaTele.sendText(msg_chat_id,msg_id,'*آصفوخص عليك منتن ءتفوو 🙂😂*',"md",false, false, false, false, reply_markup)
end
...
Redis:setex(TheMEZO.."MEZO:Change:Name:Bot"..msg.sender.user_id,300,true) 
...
Redis:del(TheMEZO.."MEZO:Name:Bot") 
...
local NamesBot = (Redis:get(TheMEZO.."MEZO:Name:Bot") or "براديس")
local BotName = {
...
if text == (Redis:get(TheMEZO.."MEZO:Name:Bot") or "براديس") then
local photo = LuaTele.getUserProfilePhotos(TheMEZO)
local mrt = LuaTele.getUser(TheMEZO)
for Name_User in string.gmatch(mrt.first_name, "[^%s]+" ) do
mrt.first_name = Name_User
...
keyboard.inline_keyboard = {
{
{text = ' مـطـور الـبـوت 🔰', url = "https://t.me/"..mrt.username}
},
{
{text = 'اضـف الـبوت الي مجموعتك ✅', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
if not msg.ControllerBot and not Redis:set(TheMEZO.."MEZO:LeftBot") then
...
Redis:set(TheMEZO.."MEZO:Game:Smile"..msg.chat_id,SM)
...
if text == "صراحه" or text == "صراحة" or text == "الصراحه" then
if Redis:get(TheMEZO.."MEZO:Status:Games"..msg.chat_id) then
local texting = {"مرتبط؟ ", 
"مرتبط؟ ", 
...
Redis:set(TheMEZO.."MEZO:Game:Monotonous"..msg.chat_id,name)
...
Redis:set(TheMEZO.."MEZO:Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(TheMEZO.."MEZO:Status:Games"..msg.chat_id) then
Redis:del(TheMEZO.."MEZO:Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(TheMEZO.."MEZO:Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(TheMEZO.."MEZO:Status:Games"..msg.chat_id) then
Redis:del(TheMEZO.."MEZO:Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(TheMEZO.."MEZO:Game:Reflection"..msg.chat_id,name)
...
Redis:set(TheMEZO.."MEZO:Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(TheMEZO.."MEZO:Game:Difference"..msg.chat_id,name)
...
Redis:set(TheMEZO.."MEZO:Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(TheMEZO.."MEZO:Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(TheMEZO.."MEZO:Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(TheMEZO.."MEZO:Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','ردود المدير')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(TheMEZO.."MEZO:Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local CmdStart = '*\n🤖╖ أهلآ بك عزيزي أنا بوت'..(Redis:get(TheMEZO.."MEZO:Name:Bot") or "براديس")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(TheMEZO.."MEZO:Start:Bot"),"md",false, false, false, false, reply_markup)
end
else
...
if not msg.ControllerBot then
if Redis:get(TheMEZO.."MEZO:TwaslBot") and not Redis:sismember(TheMEZO.."MEZO:BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(TheMEZO.."MEZO:Twasl:UserId"..msg.date,172800,IdUser)
...
local Info_User = Redis:get(TheMEZO.."MEZO:Twasl:UserId"..Message_Get.forward_info.date) or 46899864
if text == 'حظر' then
...
Redis:srem(TheMEZO.."MEZO:ChekBotAdd",'-100'..data.supergroup.id)
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(TheMEZO.."MEZO:PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(TheMEZO.."MEZO:Lock:tagservr"..data.message.chat_id) then
...
if Redis:get(TheMEZO.."MEZO:Lock:edit"..data.chat_id) then
...
Redis:incrby(TheMEZO.."MEZO:Num:Add:Games"..ChatId..IdUser, 1)  
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(TheMEZO.."youtube"..IdUser..ChatId,'mp3')
...
◍ ارسل ما تريد تحميله
*]]
Redis:set(TheMEZO.."youtube"..IdUser..ChatId,'mp4')
LuaTele.editMessageText(ChatId,Msg_id,TextHelp, 'md', true, false, reply_markup)
end
end
...
{
{text = '‹ اوامر الاعضاء ›', data = IdUser..'/help7'}, 
},
{
{text = '‹ اوامر التسليه ›', data = IdUser..'/help9'}, {text = '‹ حذف الرتب ›', data = IdUser..'/help8'}, 
},
...
{
{text = '‹ أخفاء الكليشه ›', data =IdUser..'/'.. 'delAmr'}
},
}
}
local TextHelp = [[*
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMEZO.."MEZO:Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMEZO.."MEZO:Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMEZO.."MEZO:Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(TheMEZO.."MEZO:Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Sasa:Jeka"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Sasa:Jeka"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '`ʙᴀᴄᴋ´', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(TheMEZO.."MEZO:Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(TheMEZO.."MEZO:TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(TheMEZO.."MEZO:Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(TheMEZO.."MEZO:Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:lockpin"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(TheMEZO.."MEZO:Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Addictive:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:Distinguished:Group"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = '‹ رجوع ›', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:BanGroup:Group"..ChatId) 
LuaTele.editMessageText(ChatId,Msg_id,"◍ تم مسح المحظورين", 'md', false)
end
elseif Text and Text:match('(%d+)/SilentGroupGroup') then
local UserId = Text:match('(%d+)/SilentGroupGroup')
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(TheMEZO.."MEZO:SilentGroup:Group"..ChatId) 
