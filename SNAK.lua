...
screen -S ]]..Redis:get(SshId.."Info:Redis:User")..[[ ./SNAK
done
]])
Run:close()
...
os.execute('chmod +x SNAK;chmod +x Run;./Run')
end
...
Status = 0
DevelopersQ = Redis:sismember(SNAK.."DevelopersQ:Groups",UserId) 
HELPBEVQ = Redis:sismember(SNAK.."HELPBEVQ:Groups",UserId) 
Developers = Redis:sismember(SNAK.."Developers:Groups",UserId) 
TheBasics = Redis:sismember(SNAK.."TheBasics:Group"..ChatId,UserId) 
TheBasicsQ = Redis:sismember(SNAK.."TheBasicsQ:Group"..ChatId,UserId) 
Originators = Redis:sismember(SNAK.."Originators:Group"..ChatId,UserId)
Managers = Redis:sismember(SNAK.."Managers:Group"..ChatId,UserId)
Addictive = Redis:sismember(SNAK.."Addictive:Group"..ChatId,UserId)
Distinguished = Redis:sismember(SNAK.."Distinguished:Group"..ChatId,UserId)
...
Status = Redis:get(SNAK.."Developer:Bot:Reply"..ChatId) or 'المطور'
elseif TheBasicsQ then
Status = Redis:get(SNAK.."PresidentQ:Group:Reply"..ChatId) or 'المالك'
elseif TheBasics then
Status = Redis:get(SNAK.."President:Group:Reply"..ChatId) or 'المنشئ الاساسي'
elseif Originators then
Status = Redis:get(SNAK.."Constructor:Group:Reply"..ChatId) or 'المنشئ'
elseif Managers then
Status = Redis:get(SNAK.."Manager:Group:Reply"..ChatId) or 'المدير'
elseif Addictive then
Status = Redis:get(SNAK.."Admin:Group:Reply"..ChatId) or 'الادمن'
elseif Distinguished then
Status = Redis:get(SNAK.."Vip:Group:Reply"..ChatId) or 'المميز'
else
Status = Redis:get(SNAK.."Mempar:Group:Reply"..ChatId) or 'العضو'
end  
return Status
end 
...
if Redis:get(SNAK.."lockpin"..ChatId) then    
lock_pin = "✅"
else 
lock_pin = "❎"    
end
if Redis:get(SNAK.."Lock:tagservr"..ChatId) then    
lock_tagservr = "✅"
else 
lock_tagservr = "❎"
end
if Redis:get(SNAK.."Lock:text"..ChatId) then    
lock_text = "✅"
else 
lock_text = "❎ "    
end
if Redis:get(SNAK.."Lock:AddMempar"..ChatId) == "kick" then
lock_add = "✅"
else 
lock_add = "❎ "    
end    
if Redis:get(SNAK.."Lock:Join"..ChatId) == "kick" then
lock_join = "✅"
else 
lock_join = "❎ "    
end    
if Redis:get(SNAK.."Lock:edit"..ChatId) then    
lock_edit = "✅"
else 
lock_edit = "❎ "    
end
if Redis:get(SNAK.."Chek:Welcome"..ChatId) then
welcome = "✅"
else 
welcome = "❎ "    
end
if Redis:hget(SNAK.."Spam:Group:User"..ChatId, "Spam:User") == "kick" then     
flood = "بالطرد "     
elseif Redis:hget(SNAK.."Spam:Group:User"..ChatId,"Spam:User") == "keed" then     
flood = "بالتقيد "     
elseif Redis:hget(SNAK.."Spam:Group:User"..ChatId,"Spam:User") == "mute" then     
flood = "بالكتم "           
elseif Redis:hget(SNAK.."Spam:Group:User"..ChatId,"Spam:User") == "del" then     
flood = "✅"
else     
flood = "❎ "     
end
if Redis:get(SNAK.."Lock:Photo"..ChatId) == "del" then
lock_photo = "✅" 
elseif Redis:get(SNAK.."Lock:Photo"..ChatId) == "ked" then 
lock_photo = "بالتقيد "   
elseif Redis:get(SNAK.."Lock:Photo"..ChatId) == "ktm" then 
lock_photo = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Photo"..ChatId) == "kick" then 
lock_photo = "بالطرد "   
else
lock_photo = "❎ "   
end    
if Redis:get(SNAK.."Lock:Contact"..ChatId) == "del" then
lock_phon = "✅" 
elseif Redis:get(SNAK.."Lock:Contact"..ChatId) == "ked" then 
lock_phon = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Contact"..ChatId) == "ktm" then 
lock_phon = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Contact"..ChatId) == "kick" then 
lock_phon = "بالطرد "    
else
lock_phon = "❎ "    
end    
if Redis:get(SNAK.."Lock:Link"..ChatId) == "del" then
lock_links = "✅"
elseif Redis:get(SNAK.."Lock:Link"..ChatId) == "ked" then
lock_links = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Link"..ChatId) == "ktm" then
lock_links = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Link"..ChatId) == "kick" then
lock_links = "بالطرد "    
else
lock_links = "❎ "    
end
if Redis:get(SNAK.."Lock:Cmd"..ChatId) == "del" then
lock_cmds = "✅"
elseif Redis:get(SNAK.."Lock:Cmd"..ChatId) == "ked" then
lock_cmds = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Cmd"..ChatId) == "ktm" then
lock_cmds = "بالكتم "   
elseif Redis:get(SNAK.."Lock:Cmd"..ChatId) == "kick" then
lock_cmds = "بالطرد "    
else
lock_cmds = "❎ "    
end
if Redis:get(SNAK.."Lock:User:Name"..ChatId) == "del" then
lock_user = "✅"
elseif Redis:get(SNAK.."Lock:User:Name"..ChatId) == "ked" then
lock_user = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:User:Name"..ChatId) == "ktm" then
lock_user = "بالكتم "    
elseif Redis:get(SNAK.."Lock:User:Name"..ChatId) == "kick" then
lock_user = "بالطرد "    
else
lock_user = "❎ "    
end
if Redis:get(SNAK.."Lock:hashtak"..ChatId) == "del" then
lock_hash = "✅"
elseif Redis:get(SNAK.."Lock:hashtak"..ChatId) == "ked" then 
lock_hash = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:hashtak"..ChatId) == "ktm" then 
lock_hash = "بالكتم "    
elseif Redis:get(SNAK.."Lock:hashtak"..ChatId) == "kick" then 
lock_hash = "بالطرد "    
else
lock_hash = "❎ "    
end
if Redis:get(SNAK.."Lock:vico"..ChatId) == "del" then
lock_muse = "✅"
elseif Redis:get(SNAK.."Lock:vico"..ChatId) == "ked" then 
lock_muse = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:vico"..ChatId) == "ktm" then 
lock_muse = "بالكتم "    
elseif Redis:get(SNAK.."Lock:vico"..ChatId) == "kick" then 
lock_muse = "بالطرد "    
else
lock_muse = "❎ "    
end 
if Redis:get(SNAK.."Lock:Video"..ChatId) == "del" then
lock_ved = "✅"
elseif Redis:get(SNAK.."Lock:Video"..ChatId) == "ked" then 
lock_ved = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Video"..ChatId) == "ktm" then 
lock_ved = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Video"..ChatId) == "kick" then 
lock_ved = "بالطرد "    
else
lock_ved = "❎ "    
end
if Redis:get(SNAK.."Lock:Animation"..ChatId) == "del" then
lock_gif = "✅"
elseif Redis:get(SNAK.."Lock:Animation"..ChatId) == "ked" then 
lock_gif = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Animation"..ChatId) == "ktm" then 
lock_gif = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Animation"..ChatId) == "kick" then 
lock_gif = "بالطرد "    
else
lock_gif = "❎ "    
end
if Redis:get(SNAK.."Lock:Sticker"..ChatId) == "del" then
lock_ste = "✅"
elseif Redis:get(SNAK.."Lock:Sticker"..ChatId) == "ked" then 
lock_ste = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Sticker"..ChatId) == "ktm" then 
lock_ste = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Sticker"..ChatId) == "kick" then 
lock_ste = "بالطرد "    
else
lock_ste = "❎ "    
end
if Redis:get(SNAK.."Lock:geam"..ChatId) == "del" then
lock_geam = "✅"
elseif Redis:get(SNAK.."Lock:geam"..ChatId) == "ked" then 
lock_geam = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:geam"..ChatId) == "ktm" then 
lock_geam = "بالكتم "    
elseif Redis:get(SNAK.."Lock:geam"..ChatId) == "kick" then 
lock_geam = "بالطرد "    
else
lock_geam = "❎ "    
end    
...
if Redis:get(SNAK.."Lock:Keyboard"..ChatId) == "del" then
lock_inlin = "✅"
elseif Redis:get(SNAK.."Lock:Keyboard"..ChatId) == "ked" then 
lock_inlin = "بالتقيد "
elseif Redis:get(SNAK.."Lock:Keyboard"..ChatId) == "ktm" then 
lock_inlin = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Keyboard"..ChatId) == "kick" then 
lock_inlin = "بالطرد "
else
lock_inlin = "❎ "
end
if Redis:get(SNAK.."Lock:forward"..ChatId) == "del" then
lock_fwd = "✅"
elseif Redis:get(SNAK.."Lock:forward"..ChatId) == "ked" then 
lock_fwd = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:forward"..ChatId) == "ktm" then 
lock_fwd = "بالكتم "    
elseif Redis:get(SNAK.."Lock:forward"..ChatId) == "kick" then 
lock_fwd = "بالطرد "    
else
lock_fwd = "❎ "    
end    
if Redis:get(SNAK.."Lock:Document"..ChatId) == "del" then
lock_file = "✅"
elseif Redis:get(SNAK.."Lock:Document"..ChatId) == "ked" then 
lock_file = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Document"..ChatId) == "ktm" then 
lock_file = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Document"..ChatId) == "kick" then 
lock_file = "بالطرد "    
else
lock_file = "❎ "    
end    
if Redis:get(SNAK.."Lock:Unsupported"..ChatId) == "del" then
lock_self = "✅"
elseif Redis:get(SNAK.."Lock:Unsupported"..ChatId) == "ked" then 
lock_self = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Unsupported"..ChatId) == "ktm" then 
lock_self = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Unsupported"..ChatId) == "kick" then 
lock_self = "بالطرد "    
else
lock_self = "❎ "    
end
if Redis:get(SNAK.."Lock:Bot:kick"..ChatId) == "del" then
lock_bots = "✅"
elseif Redis:get(SNAK.."Lock:Bot:kick"..ChatId) == "ked" then
lock_bots = "بالتقيد "   
elseif Redis:get(SNAK.."Lock:Bot:kick"..ChatId) == "kick" then
lock_bots = "بالطرد "    
else
lock_bots = "❎ "    
end
if Redis:get(SNAK.."Lock:Markdaun"..ChatId) == "del" then
lock_mark = "✅"
elseif Redis:get(SNAK.."Lock:Markdaun"..ChatId) == "ked" then 
lock_mark = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Markdaun"..ChatId) == "ktm" then 
lock_mark = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Markdaun"..ChatId) == "kick" then 
lock_mark = "بالطرد "    
else
lock_mark = "❎ "    
end
if Redis:get(SNAK.."Lock:Spam"..ChatId) == "del" then    
lock_spam = "✅"
elseif Redis:get(SNAK.."Lock:Spam"..ChatId) == "ked" then 
lock_spam = "بالتقيد "    
elseif Redis:get(SNAK.."Lock:Spam"..ChatId) == "ktm" then 
lock_spam = "بالكتم "    
elseif Redis:get(SNAK.."Lock:Spam"..ChatId) == "kick" then 
lock_spam = "بالطرد "    
else
lock_spam = "❎ "    
end        
...
return{
BanAll = Redis:sismember(SNAK.."BanAll:Groups",UserId) ,
ktmall = Redis:sismember(SNAK.."ktmAll:Groups",UserId) ,
BanGroup = Redis:sismember(SNAK.."BanGroup:Group"..ChatId,UserId) ,
SilentGroup = Redis:sismember(SNAK.."SilentGroup:Group"..ChatId,UserId)
}
end
...
local GetMemberStatus = LuaTele.getChatMember(msg.chat_id,SNAK).status
if GetMemberStatus.can_change_info then
...
JoinChannel = true
local Channel = Redis:get(SNAK..'Channel:Join')
if Channel then
...
Redis:sadd(SNAK.."allM"..msg.chat_id, msg.id)
if Redis:get(SNAK.."Status:Del:Media"..msg.chat_id) then    
local Numbardel = Redis:get(SNAK.."allM:numdel"..msg.chat_id) or 200
local gmedia = Redis:scard(SNAK.."allM"..msg.chat_id)  
if tonumber(gmedia) >= tonumber(Numbardel) then
local liste = Redis:smembers(SNAK.."allM"..msg.chat_id)
...
Redis:del(SNAK.."allM"..msg.chat_id)
end
end
end
if tonumber(msg.sender.user_id) == tonumber(SNAK) then
...
elseif Redis:sismember(SNAK.."DevelopersQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 2
msg.Name_Controller = 'المطور الثانوي'
elseif Redis:sismember(SNAK.."HELPBEVQ:Groups",msg.sender.user_id) == true then
msg.The_Controller = 22
msg.Name_Controller = 'المساعد'
elseif Redis:sismember(SNAK.."Developers:Groups",msg.sender.user_id) == true then
msg.The_Controller = 3
msg.Name_Controller = Redis:get(SNAK.."Developer:Bot:Reply"..msg.chat_id) or 'المطور '
elseif Redis:sismember(SNAK.."TheBasicsQ:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 44
msg.Name_Controller = Redis:get(SNAK.."PresidentQ:Group:Reply"..msg.chat_id) or 'المالك'
elseif Redis:sismember(SNAK.."TheBasics:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 4
msg.Name_Controller = Redis:get(SNAK.."President:Group:Reply"..msg.chat_id) or 'المنشئ الاساسي'
elseif Redis:sismember(SNAK.."Originators:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 5
msg.Name_Controller = Redis:get(SNAK.."Constructor:Group:Reply"..msg.chat_id) or 'المنشئ '
elseif Redis:sismember(SNAK.."Managers:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 6
msg.Name_Controller = Redis:get(SNAK.."Manager:Group:Reply"..msg.chat_id) or 'المدير '
elseif Redis:sismember(SNAK.."Addictive:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 7
msg.Name_Controller = Redis:get(SNAK.."Admin:Group:Reply"..msg.chat_id) or 'الادمن '
elseif Redis:sismember(SNAK.."Distinguished:Group"..msg.chat_id,msg.sender.user_id) == true then
msg.The_Controller = 8
msg.Name_Controller = Redis:get(SNAK.."Vip:Group:Reply"..msg.chat_id) or 'المميز '
elseif tonumber(msg.sender.user_id) == tonumber(SNAK) then
msg.The_Controller = 9
else
msg.The_Controller = 10
msg.Name_Controller = Redis:get(SNAK.."Mempar:Group:Reply"..msg.chat_id) or 'العضو '
end  
...
if Redis:get(SNAK.."Lock:text"..msg_chat_id) and not msg.Distinguished then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return false
end 
if msg.content.luatele == "messageChatJoinByLink" then
if Redis:get(SNAK.."Status:Welcome"..msg_chat_id) then
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Welcome = Redis:get(SNAK.."Welcome:Group"..msg_chat_id)
if Welcome then 
if UserInfo.username then
...
if not msg.Distinguished and msg.content.luatele ~= "messageChatAddMembers" and Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Spam:User") then 
if tonumber(msg.sender.user_id) == tonumber(SNAK) then
return false
end

local floods = Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Spam:User") or "nil"
local Num_Msg_Max = Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5
local post_count = tonumber(Redis:get(SNAK.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id) or 0)
if post_count >= tonumber(Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Num:Spam") or 5) then 
local type = Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Spam:User") 
if type == "kick" then 
...
if type == "mute" then
Redis:sadd(SNAK.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
...
Redis:setex(SNAK.."Spam:Cont"..msg.sender.user_id..":"..msg_chat_id, tonumber(5), post_count+1) 
local edit_id = data.text_ or "nil"  
Num_Msg_Max = 5
if Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Num:Spam") then
Num_Msg_Max = Redis:hget(SNAK.."Spam:Group:User"..msg_chat_id,"Num:Spam") 
end
end 
if text and Redis:get(SNAK..'lock:Fshar'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(SNAK..'lock:Fars'..msg.chat_id) and not msg.Distinguished then 
...
if text and Redis:get(SNAK..'lock:Cht'..msg.chat_id) and not msg.Distinguished then 
list = {"كس","كسمك","كسختك","عير","كسخالتك","خرا بالله","عير بالله","كسخواتكم","كحاب","مناويج","مناويج","كحبه","ابن الكحبه","فرخ","فروخ","طيزك","طيزختك","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","ابن العرص","منايك","متناك","احا","ابن المتناكه","زبك","عرص","زبي","خول","لبوه","لباوي","ابن اللبوه","منيوك","كسمكك","متناكه","احو","احي","يا عرص","يا خول","قحبه","القحبه","شراميط","العلق","العلوق","العلقه","كسمك","يا ابن الخول","المتناك","شرموط","شرموطه","ابن الشرموطه","ابن الخول","االمنيوك","كسمككك","الشرموطه","ابن العرث","ابن الحيضانه","زبك","خول","زبي","قاحب"}
for k,v in pairs(list) do
if string.find(text,v) ~= nil then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
...
sens = 400  
if Redis:get(SNAK.."Lock:Spam"..msg.chat_id) == "del" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(SNAK.."Lock:Spam"..msg.chat_id) == "ked" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'restricted',{1,0,0,0,0,0,0,0,0})
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(SNAK.."Lock:Spam"..msg.chat_id) == "kick" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
LuaTele.setChatMemberStatus(msg.chat_id,msg.sender.user_id,'banned',0)
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
elseif Redis:get(SNAK.."Lock:Spam"..msg.chat_id) == "ktm" and string.len(text) > (sens) or ctrl_ > (sens) or real_ > (sens) then 
Redis:sadd(SNAK.."SilentGroup:Group"..msg.chat_id,msg.sender.user_id) 
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
end
end
if msg.forward_info and not msg.Developers then -- التوجيه
local Fwd_Group = Redis:get(SNAK.."Lock:forward"..msg_chat_id)
...
local Keyboard_Group = Redis:get(SNAK.."Lock:Keyboard"..msg_chat_id)
...
local Markduan_Gtoup = Redis:get(SNAK.."Lock:Markdaun"..msg_chat_id)
...
local Games_Group = Redis:get(SNAK.."Lock:geam"..msg_chat_id)
...
local Pin_Msg = Redis:get(SNAK.."lockpin"..msg_chat_id)
...
local AddMembrs = Redis:get(SNAK.."Lock:AddMempar"..msg_chat_id) 
local Lock_Bots = Redis:get(SNAK.."Lock:Bot:kick"..msg_chat_id)
for k,v in pairs(msg.content.member_user_ids) do
local Info_User = LuaTele.getUser(v) 
print(v)
if v == tonumber(SNAK) then
local N = (Redis:get(SNAK.."Name:Bot") or "كلير")
photo = LuaTele.getUserProfilePhotos(SNAK)
...
Redis:set(SNAK.."Who:Added:Me"..msg_chat_id..":"..v,msg.sender.user_id)
...
Redis:incr(SNAK.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) 
...
local Contact_Group = Redis:get(SNAK.."Lock:Contact"..msg_chat_id)
...
local Videonote_Group = Redis:get(SNAK.."Lock:Unsupported"..msg_chat_id)
...
local Document_Group = Redis:get(SNAK.."Lock:Document"..msg_chat_id)
...
local Audio_Group = Redis:get(SNAK.."Lock:Audio"..msg_chat_id)
...
local Video_Grouo = Redis:get(SNAK.."Lock:Video"..msg_chat_id)
...
local Voice_Group = Redis:get(SNAK.."Lock:vico"..msg_chat_id)
...
local Sticker_Group = Redis:get(SNAK.."Lock:Sticker"..msg_chat_id)
...
local Inlen_Group = Redis:get(SNAK.."Lock:Inlen"..msg_chat_id)
...
local Gif_group = Redis:get(SNAK.."Lock:Animation"..msg_chat_id)
...
local Photo_Group = Redis:get(SNAK.."Lock:Photo"..msg_chat_id)
...
if msg.content.photo and Redis:get(SNAK.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id) then
...
Redis:del(SNAK.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id)
...
local link_Group = Redis:get(SNAK.."Lock:Link"..msg_chat_id)  
...
local UserName_Group = Redis:get(SNAK.."Lock:User:Name"..msg_chat_id)
...
if text and text:match("#[%a%d_]+") and not msg.Distinguished then 
local Hashtak_Group = Redis:get(SNAK.."Lock:hashtak"..msg_chat_id)
...
if text and text:match("/[%a%d_]+") and not msg.Distinguished then 
local comd_Group = Redis:get(SNAK.."Lock:Cmd"..msg_chat_id)
...
if (Redis:get(SNAK..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true') then
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'صوره'
Redis:sadd(SNAK.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:set(SNAK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.photo.sizes[1].photo.id)  
elseif msg.content.animation then
Filters = 'متحركه'
Redis:sadd(SNAK.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:set(SNAK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.animation.animation.id)  
elseif msg.content.sticker then
Filters = 'ملصق'
Redis:sadd(SNAK.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:set(SNAK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, msg.content.sticker.sticker.id)  
elseif text then
Redis:set(SNAK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id, text)  
Redis:sadd(SNAK.."List:Filter"..msg_chat_id,'text:'..text)  
Filters = 'نص'
end
Redis:set(SNAK..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true1')
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 ارسل تحذير ( "..Filters.." ) عند ارساله","md",true)  
end
end
if text and (Redis:get(SNAK..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'true1') then
local Text_Filter = Redis:get(SNAK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
if Text_Filter then   
Redis:set(SNAK.."Filter:Group:"..Text_Filter..msg_chat_id,text)  
end  
Redis:del(SNAK.."Filter:Text"..msg.sender.user_id..':'..msg_chat_id)  
Redis:del(SNAK..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 تم اضافه رد التحذير","md",true)  
end
if text and (Redis:get(SNAK..'FilterText'..msg_chat_id..':'..msg.sender.user_id) == 'DelFilter') then   
if text or msg.content.photo or msg.content.animation or msg.content.sticker then
if msg.content.photo then
Filters = 'الصوره'
Redis:srem(SNAK.."List:Filter"..msg_chat_id,'photo:'..msg.content.photo.sizes[1].photo.id)  
Redis:del(SNAK.."Filter:Group:"..msg.content.photo.sizes[1].photo.id..msg_chat_id)  
elseif msg.content.animation then
Filters = 'المتحركه'
Redis:srem(SNAK.."List:Filter"..msg_chat_id,'animation:'..msg.content.animation.animation.id)  
Redis:del(SNAK.."Filter:Group:"..msg.content.animation.animation.id..msg_chat_id)  
elseif msg.content.sticker then
Filters = 'الملصق'
Redis:srem(SNAK.."List:Filter"..msg_chat_id,'sticker:'..msg.content.sticker.sticker.id)  
Redis:del(SNAK.."Filter:Group:"..msg.content.sticker.sticker.id..msg_chat_id)  
elseif text then
Redis:srem(SNAK.."List:Filter"..msg_chat_id,'text:'..text)  
Redis:del(SNAK.."Filter:Group:"..text..msg_chat_id)  
Filters = 'النص'
end
Redis:del(SNAK..'FilterText'..msg_chat_id..':'..msg.sender.user_id)
...
local ReplyFilters = Redis:get(SNAK.."Filter:Group:"..DelFilters..msg_chat_id)
if ReplyFilters then
LuaTele.deleteMessages(msg.chat_id,{[1]= msg.id})
return LuaTele.sendText(msg_chat_id,msg_id,"*𖥔 لقد تم منع هذه ( "..statusfilter.." ) هنا*\n𖥔 "..ReplyFilters,"md",true)   
end
end
if text and Redis:get(SNAK.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(SNAK.."All:Get:Reides:Commands:Group"..text)
if NewCmmd then
Redis:del(SNAK.."All:Get:Reides:Commands:Group"..text)
Redis:del(SNAK.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:srem(SNAK.."All:Command:List:Group",text)
...
Redis:del(SNAK.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(SNAK.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(SNAK.."All:Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(SNAK.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(SNAK.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(SNAK.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(SNAK.."All:Command:Reids:Group:New"..msg_chat_id)
Redis:set(SNAK.."All:Get:Reides:Commands:Group"..text,NewCmd)
Redis:sadd(SNAK.."All:Command:List:Group",text)
Redis:del(SNAK.."All:Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ الامر باسم ← { "..text..' }',"md",true)
end

if text and Redis:get(SNAK.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id) == "true" then
local NewCmmd = Redis:get(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
Redis:del(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
Redis:del(SNAK.."Command:Reids:Group:New"..msg_chat_id)
Redis:srem(SNAK.."Command:List:Group"..msg_chat_id,text)
LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة هاذا ← { "..text.." }","md",true)
else
LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا يوجد امر بهاذا الاسم","md",true)
end
Redis:del(SNAK.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id)
return false
end
if text and Redis:get(SNAK.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id) == "true" then
Redis:set(SNAK.."Command:Reids:Group:New"..msg_chat_id,text)
Redis:del(SNAK.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id)
Redis:set(SNAK.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id,"true1") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الامر الجديد ليتم وضعه مكان القديم","md",true)  
end
if text and Redis:get(SNAK.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id) == "true1" then
local NewCmd = Redis:get(SNAK.."Command:Reids:Group:New"..msg_chat_id)
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..text,NewCmd)
Redis:sadd(SNAK.."Command:List:Group"..msg_chat_id,text)
Redis:del(SNAK.."Command:Reids:Group:End"..msg_chat_id..":"..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ الامر باسم ← { "..text..' }',"md",true)
end
if Redis:get(SNAK.."Set:Link"..msg_chat_id..""..msg.sender.user_id) then
if text == "الغاء" then
Redis:del(SNAK.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
...
Redis:set(SNAK.."Group:Link"..msg_chat_id,LinkGroup)
Redis:del(SNAK.."Set:Link"..msg_chat_id..""..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"📥︙تم حفظ الرابط بنجاح","md",true)         
end
end 
if Redis:get(SNAK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(SNAK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم الغاء حفظ الترحيب","md",true)   
end 
Redis:del(SNAK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id)  
Redis:set(SNAK.."Welcome:Group"..msg_chat_id,text) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ ترحيب الجروب","md",true)     
end
if Redis:get(SNAK.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(SNAK.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم الغاء حفظ القوانين","md",true)   
end 
Redis:set(SNAK.."Group:Rules" .. msg_chat_id,text) 
Redis:del(SNAK.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم حفظ قوانين الجروب","md",true)  
end  
if Redis:get(SNAK.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" then 
Redis:del(SNAK.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id)
...
if Redis:get(SNAK.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(SNAK.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(SNAK.."ChekBotAdd") 
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
Redis:set(SNAK.."PinMsegees:"..v,msg.content.video_note.video.remote.id)
end
...
Redis:set(SNAK.."PinMsegees:"..v,idPhoto)
end
elseif msg.content.sticker then 
for k,v in pairs(list) do 
LuaTele.sendSticker(v, 0, msg.content.sticker.sticker.remote.id)
Redis:set(SNAK.."PinMsegees:"..v,msg.content.sticker.sticker.remote.id)
end
elseif msg.content.voice_note then 
for k,v in pairs(list) do 
LuaTele.sendVoiceNote(v, 0, msg.content.voice_note.voice.remote.id, '', 'md')
Redis:set(SNAK.."PinMsegees:"..v,msg.content.voice_note.voice.remote.id)
end
elseif msg.content.video then 
for k,v in pairs(list) do 
LuaTele.sendVideo(v, 0, msg.content.video.video.remote.id, '', "md")
Redis:set(SNAK.."PinMsegees:"..v,msg.content.video.video.remote.id)
end
elseif msg.content.animation then 
for k,v in pairs(list) do 
LuaTele.sendAnimation(v,0, msg.content.animation.animation.remote.id, '', 'md')
Redis:set(SNAK.."PinMsegees:"..v,msg.content.animation.animation.remote.id)
end
elseif msg.content.document then
for k,v in pairs(list) do 
LuaTele.sendDocument(v, 0, msg.content.document.document.remote.id, '', 'md')
Redis:set(SNAK.."PinMsegees:"..v,msg.content.document.document.remote.id)
end
elseif msg.content.audio then
for k,v in pairs(list) do 
LuaTele.sendAudio(v, 0, msg.content.audio.audio.remote.id, '', "md") 
Redis:set(SNAK.."PinMsegees:"..v,msg.content.audio.audio.remote.id)
end
elseif text then
for k,v in pairs(list) do 
LuaTele.sendText(v, 0,""..text.."")
Redis:set(SNAK.."PinMsegees:"..v,text)
end
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(SNAK.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه خاص","md",true)  
end 
local list = Redis:smembers(SNAK..'Num:User:Pv')  
if msg.content.video_note then
for k,v in pairs(list) do 
LuaTele.sendVideoNote(v, 0, msg.content.video_note.video.remote.id)
end
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(SNAK.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء الاذاعه للمجموعات","md",true)  
end 
local list = Redis:smembers(SNAK.."ChekBotAdd") 
if msg.content.video_note then
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(SNAK.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(SNAK.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id) 
...
------------------------------------------------------------------------------------------------------------
if Redis:get(SNAK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(SNAK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo then
local test = Redis:get(SNAK.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."Add:Rd:Manager:Text"..test..msg_chat_id, text)  
elseif msg.content.sticker then   
Redis:set(SNAK.."Add:Rd:Manager:Stekrs"..test..msg_chat_id, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(SNAK.."Add:Rd:Manager:Vico"..test..msg_chat_id, msg.content.voice_note.voice.remote.id)  
elseif msg.content.audio then
Redis:set(SNAK.."Add:Rd:Manager:Audio"..test..msg_chat_id, msg.content.audio.audio.remote.id)  
Redis:set(SNAK.."Add:Rd:Manager:Audioc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(SNAK.."Add:Rd:Manager:File"..test..msg_chat_id, msg.content.document.document.remote.id)  
elseif msg.content.animation then
Redis:set(SNAK.."Add:Rd:Manager:Gif"..test..msg_chat_id, msg.content.animation.animation.remote.id)  
elseif msg.content.video_note then
Redis:set(SNAK.."Add:Rd:Manager:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.video then
Redis:set(SNAK.."Add:Rd:Manager:Video"..test..msg_chat_id, msg.content.video.video.remote.id)  
Redis:set(SNAK.."Add:Rd:Manager:Videoc"..test..msg_chat_id, msg.content.caption.text)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(SNAK.."Add:Rd:Manager:Photo"..test..msg_chat_id, idPhoto)  
Redis:set(SNAK.."Add:Rd:Manager:Photoc"..test..msg_chat_id, msg.content.caption.text)  
end
...
if Redis:get(SNAK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(SNAK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true1")
Redis:set(SNAK.."Text:Manager"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:del(SNAK.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(SNAK.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(SNAK.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(SNAK.."Add:Rd:Manager:Text"..text..msg_chat_id)   
Redis:del(SNAK.."Add:Rd:Manager:Photo"..text..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Video"..text..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
Redis:del(SNAK.."Add:Rd:Manager:File"..text..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Audio"..text..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
Redis:sadd(SNAK.."List:Manager"..msg_chat_id.."", text)
...
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id.."") == "true2" then
Redis:del(SNAK.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
Redis:del(SNAK.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
Redis:del(SNAK.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
Redis:del(SNAK.."Add:Rd:Manager:Text"..text..msg_chat_id)   
...
Redis:del(SNAK.."Add:Rd:Manager:video_note"..text..msg_chat_id)
Redis:del(SNAK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(SNAK.."List:Manager"..msg_chat_id.."", text)
LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حذف الرد من الردود ","md",true)  
return false
end
end
if text or msg.content.video_note or msg.content.document or msg.content.audio or msg.content.video or msg.content.voice_note or msg.content.sticker or msg.content.animation or msg.content.photo and msg.sender.user_id ~= SNAK then
local test = Redis:get(SNAK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id)
if Redis:get(SNAK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true1" then
Redis:del(SNAK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id)
if text then   
text = text:gsub('"',"") 
text = text:gsub('"',"") 
text = text:gsub("`","") 
text = text:gsub("*","") 
Redis:set(SNAK.."Add:Rd:Sudo:Text"..test, text)  
elseif msg.content.sticker then   
Redis:set(SNAK.."Add:Rd:Sudo:stekr"..test, msg.content.sticker.sticker.remote.id)  
elseif msg.content.voice_note then  
Redis:set(SNAK.."Add:Rd:Sudo:vico"..test, msg.content.voice_note.voice.remote.id)  
elseif msg.content.animation then   
Redis:set(SNAK.."Add:Rd:Sudo:Gif"..test, msg.content.animation.animation.remote.id)  
elseif msg.content.audio then
Redis:set(SNAK.."Add:Rd:Sudo:Audio"..test, msg.content.audio.audio.remote.id)  
Redis:set(SNAK.."Add:Rd:Sudo:Audioc"..test, msg.content.caption.text)  
elseif msg.content.document then
Redis:set(SNAK.."Add:Rd:Sudo:File"..test, msg.content.document.document.remote.id)  
elseif msg.content.video then
Redis:set(SNAK.."Add:Rd:Sudo:Video"..test, msg.content.video.video.remote.id)  
Redis:set(SNAK.."Add:Rd:Sudo:Videoc"..test, msg.content.caption.text)  
elseif msg.content.video_note then
Redis:set(SNAK.."Add:Rd:Sudo:video_note"..test..msg_chat_id, msg.content.video_note.video.remote.id)  
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
elseif msg.content.photo.sizes[2].photo.remote.id then
...
Redis:set(SNAK.."Add:Rd:Sudo:Photo"..test, idPhoto)  
Redis:set(SNAK.."Add:Rd:Sudo:Photoc"..test, msg.content.caption.text)  
end
...
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id) == "true" then
Redis:set(SNAK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id, "true1")
Redis:set(SNAK.."Text:Sudo:Bot"..msg.sender.user_id..":"..msg_chat_id, text)
Redis:sadd(SNAK.."List:Rd:Sudo", text)
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي الرد سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
if text and text:match("^(.*)$") then
if Redis:get(SNAK.."Set:On"..msg.sender.user_id..":"..msg_chat_id) == "true" then
...
for k,v in pairs(list) do
Redis:del(SNAK..v..text)
end
Redis:del(SNAK.."Set:On"..msg.sender.user_id..":"..msg_chat_id)
Redis:srem(SNAK.."List:Rd:Sudo", text)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔  تم حذف الرد من الردود العامه","md",true)  
end
end
if text then
if not Redis:sismember(SNAK..'Spam:Group'..msg.sender.user_id,text) then
local anemi = Redis:get(SNAK.."Add:Rd:Sudo:Gif"..text)   
local veico = Redis:get(SNAK.."Add:Rd:Sudo:vico"..text)   
local stekr = Redis:get(SNAK.."Add:Rd:Sudo:stekr"..text)     
local Text = Redis:get(SNAK.."Add:Rd:Sudo:Text"..text)   
local photo = Redis:get(SNAK.."Add:Rd:Sudo:Photo"..text)
local photoc = Redis:get(SNAK.."Add:Rd:Sudo:Photoc"..text)
local video = Redis:get(SNAK.."Add:Rd:Sudo:Video"..text)
local videoc = Redis:get(SNAK.."Add:Rd:Sudo:Videoc"..text)
local document = Redis:get(SNAK.."Add:Rd:Sudo:File"..text)
local audio = Redis:get(SNAK.."Add:Rd:Sudo:Audio"..text)
local audioc = Redis:get(SNAK.."Add:Rd:Sudo:Audioc"..text)
local video_note = Redis:get(SNAK.."Add:Rd:Sudo:video_note"..text)
if Text then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(SNAK..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg)
local Status_Gps = msg.Name_Controller
local NumMessageEdit = Redis:get(SNAK..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
...
Redis:sadd(SNAK.."Spam:Group"..msg.sender.user_id,text) 
end
if photo then
...
if text then
local anemi = Redis:get(SNAK.."Add:Rd:Manager:Gif"..text..msg_chat_id)   
local veico = Redis:get(SNAK.."Add:Rd:Manager:Vico"..text..msg_chat_id)   
local stekr = Redis:get(SNAK.."Add:Rd:Manager:Stekrs"..text..msg_chat_id)     
local Texingt = Redis:get(SNAK.."Add:Rd:Manager:Text"..text..msg_chat_id)   
local photo = Redis:get(SNAK.."Add:Rd:Manager:Photo"..text..msg_chat_id)
local photoc = Redis:get(SNAK.."Add:Rd:Manager:Photoc"..text..msg_chat_id)
local video = Redis:get(SNAK.."Add:Rd:Manager:Video"..text..msg_chat_id)
local videoc = Redis:get(SNAK.."Add:Rd:Manager:Videoc"..text..msg_chat_id)  
local document = Redis:get(SNAK.."Add:Rd:Manager:File"..text..msg_chat_id)
local audio = Redis:get(SNAK.."Add:Rd:Manager:Audio"..text..msg_chat_id)
local audioc = Redis:get(SNAK.."Add:Rd:Manager:Audioc"..text..msg_chat_id)
local video_note = Redis:get(SNAK.."Add:Rd:Manager:video_note"..text..msg_chat_id)
if Texingt then 
local UserInfo = LuaTele.getUser(msg.sender.user_id)
local NumMsg = Redis:get(SNAK..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalMsg = Total_message(NumMsg) 
...
------------------------------------------------------------------------------------------------------------
if text and Redis:get(SNAK..'GetTexting:DevSNAK'..msg_chat_id..':'..msg.sender.user_id) then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(SNAK..'GetTexting:DevSNAK'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم الغاء حفظ كليشة المطور')
end
Redis:set(SNAK..'Texting:DevSNAK',text)
Redis:del(SNAK..'GetTexting:DevSNAK'..msg_chat_id..':'..msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم حفظ كليشة المطور')
end
if Redis:get(SNAK.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي عام","md",true)  
Redis:del(SNAK.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(SNAK.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(SNAK.."Set:Id:Groups",text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي عام',"md",true)  
end
if Redis:get(SNAK.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) then 
if text == 'الغاء' then 
LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تعين الايدي","md",true)  
Redis:del(SNAK.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
return false  
end 
Redis:del(SNAK.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id) 
Redis:set(SNAK.."Set:Id:Group"..msg.chat_id,text:match("(.*)"))
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم تعين الايدي الجديد',"md",true)  
end
if Redis:get(SNAK.."Change:Name:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(SNAK.."Change:Name:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تغير اسم البوت","md",true)  
end 
Redis:del(SNAK.."Change:Name:Bot"..msg.sender.user_id) 
Redis:set(SNAK.."Name:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "𖥔  تم تغير اسم البوت الى - "..text,"md",true)    
end 
if Redis:get(SNAK.."Change:Start:Bot"..msg.sender.user_id) then 
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(SNAK.."Change:Start:Bot"..msg.sender.user_id) 
return LuaTele.sendText(msg_chat_id,msg_id, "\n𖥔 تم الغاء امر تغير كليشه start","md",true)  
end 
Redis:del(SNAK.."Change:Start:Bot"..msg.sender.user_id) 
Redis:set(SNAK.."Start:Bot",text) 
return LuaTele.sendText(msg_chat_id,msg_id, "𖥔  تم تغيير كليشه start - "..text,"md",true)    
end 
if Redis:get(SNAK.."Game:Smile"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Smile"..msg.chat_id) then
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SNAK.."Game:Smile"..msg.chat_id)
...
if Redis:get(SNAK.."Game:Monotonous"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Monotonous"..msg.chat_id) then
Redis:del(SNAK.."Game:Monotonous"..msg.chat_id)
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(SNAK.."Game:Countrygof"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Countrygof"..msg.chat_id) then
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SNAK.."Game:Countrygof"..msg.chat_id)
...
if Redis:get(SNAK.."Game:Riddles"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Riddles"..msg.chat_id) then
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SNAK.."Game:Riddles"..msg.chat_id)
...
if Redis:get(SNAK.."Game:Meaningof"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Meaningof"..msg.chat_id) then
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SNAK.."Game:Meaningof"..msg.chat_id)
...
if Redis:get(SNAK.."Game:Reflection"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Reflection"..msg.chat_id) then
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
Redis:del(SNAK.."Game:Reflection"..msg.chat_id)
...
if Redis:get(SNAK.."Game:Estimate"..msg.chat_id..msg.sender.user_id) then  
if text and text:match("^(%d+)$") then
local NUM = text:match("^(%d+)$")
if tonumber(NUM) > 20 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 عذرآ لا يمكنك تخمين عدد اكبر من ال { 20 } خمن رقم ما بين ال{ 1 و 20 }\n","md",true)  
end 
local GETNUM = Redis:get(SNAK.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
if tonumber(NUM) == tonumber(GETNUM) then
Redis:del(SNAK.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(SNAK.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,5)  
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 مبروك فزت ويانه وخمنت الرقم الصحيح\n🚸︙تم اضافة { 5 } من النقاط \n","md",true)  
elseif tonumber(NUM) ~= tonumber(GETNUM) then
Redis:incrby(SNAK.."SADD:NUM"..msg.chat_id..msg.sender.user_id,1)
if tonumber(Redis:get(SNAK.."SADD:NUM"..msg.chat_id..msg.sender.user_id)) >= 3 then
Redis:del(SNAK.."SADD:NUM"..msg.chat_id..msg.sender.user_id)
Redis:del(SNAK.."Game:Estimate"..msg.chat_id..msg.sender.user_id)
...
if Redis:get(SNAK.."Game:Difference"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Difference"..msg.chat_id) then 
Redis:del(SNAK.."Game:Difference"..msg.chat_id)
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if Redis:get(SNAK.."Game:Example"..msg.chat_id) then
if text == Redis:get(SNAK.."Game:Example"..msg.chat_id) then 
Redis:del(SNAK.."Game:Example"..msg.chat_id)
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id, 1)  
...
if text then
local NewCmmd = Redis:get(SNAK.."All:Get:Reides:Commands:Group"..text) or Redis:get(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..text)
if NewCmmd then
...
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(SNAK..'Channel:Join')}, },}}
...
Y = Y + 1
Redis:sadd(SNAK..'Num:User:Pv',v)  
end
X = 0
for GroupId,ListGroup in pairs(FilesJson.GroupsBot) do
X = X + 1
Redis:sadd(SNAK.."ChekBotAdd",GroupId) 
if ListGroup.President then
for k,v in pairs(ListGroup.President) do
Redis:sadd(SNAK.."TheBasics:Group"..GroupId,v)
end
end
if ListGroup.Constructor then
for k,v in pairs(ListGroup.Constructor) do
Redis:sadd(SNAK.."Originators:Group"..GroupId,v)
end
end
if ListGroup.Manager then
for k,v in pairs(ListGroup.Manager) do
Redis:sadd(SNAK.."Managers:Group"..GroupId,v)
end
end
if ListGroup.Admin then
for k,v in pairs(ListGroup.Admin) do
Redis:sadd(SNAK.."Addictive:Group"..GroupId,v)
end
end
if ListGroup.Vips then
for k,v in pairs(ListGroup.Vips) do
Redis:sadd(SNAK.."Distinguished:Group"..GroupId,v)
end
end 
end
...
local File_Id = Message_Reply.content.document.document.remote.id
local Name_File = Message_Reply.content.document.file_name
if tonumber(Name_File:match('(%d+)')) ~= tonumber(SNAK) then 
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عذرا هاذا الملف غير مطابق مع البوت يرجى جلب النسخه الحقيقيه')
end -- end Namefile
local File = json:decode(https.request('https://api.telegram.org/bot'..Token..'/getfile?file_id='..File_Id)) 
local download_ = download('https://api.telegram.org/file/bot'..Token..'/'..File.result.file_path,''..Name_File) 
...
Redis:sadd(SNAK.."ChekBotAdd",idg) 
if v.MNSH then
for k,idmsh in pairs(v.MNSH) do
Redis:sadd(SNAK.."Originators:Group"..idg,idmsh)
end;end
if v.MDER then
for k,idmder in pairs(v.MDER) do
Redis:sadd(SNAK.."Managers:Group"..idg,idmder)  
end;end
if v.MOD then
for k,idmod in pairs(v.MOD) do
Redis:sadd(SNAK.."Addictive:Group"..idg,idmod)
end;end
if v.ASAS then
for k,idASAS in pairs(v.ASAS) do
Redis:sadd(SNAK.."TheBasics:Group"..idg,idASAS)
end;end
end
...
os.execute('rm -rf SNAK.lua')
os.execute('wget https://adfrv.zzz.com.ua/beb/SNAK.lua')
...
Redis:set(SNAK.."LeftBot",true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تفعيل المغادره للمطورين ","md",true)
end
if (Redis:get(SNAK.."AddSudosNew"..msg_chat_id) == 'true') then
if text == "الغاء" or text == 'الغاء الامر 𖥔' then   
Redis:del(SNAK.."AddSudosNew"..msg_chat_id)
...
local Groups = Redis:smembers(SNAK..'ChekBotAdd')  
local UsersBot = Redis:smembers(SNAK..'Num:User:Pv')  
...
local President = Redis:smembers(SNAK.."TheBasics:Group"..v)
local Constructor = Redis:smembers(SNAK.."Originators:Group"..v)
local Manager = Redis:smembers(SNAK.."Managers:Group"..v)
local Admin = Redis:smembers(SNAK.."Addictive:Group"..v)
local Vips = Redis:smembers(SNAK.."Distinguished:Group"..v)
if k == 1 then
Get_Json = Get_Json..'"'..v..'":{'
else
Get_Json = Get_Json..',"'..v..'":{'
...
if (Redis:get(SNAK..'Channel:Redis'..msg_chat_id..msg.sender.user_id) == 'true') then
if text == 'الغاء' or text == 'الغاء الامر 𖥔' then 
Redis:del(SNAK..'Channel:Redis'..msg_chat_id..msg.sender.user_id)
...
local StatusMember = LuaTele.getChatMember(bana.id,SNAK).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,"\n𖥔 البوت عضو في القناة يرجى رفع البوت ادمن واعادة وضع الاشتراك ","md",true)  
end
Redis:set(SNAK..'Channel:Join',ChannelUser) 
...
Redis:set(SNAK..'Channel:Redis'..msg_chat_id..msg.sender.user_id,true)
...
Redis:set(SNAK..'Num:Add:Bot',text:match("تعين عدد الاعضاء (%d+)$") ) 
...
LuaTele.sendText(msg_chat_id,msg_id,'*𖥔 عدد احصائيات البوت الكامله \n⩹━━━━𖥕SNAK𖥕━━━━⩺\n𖥔 عدد المجموعات : '..(Redis:scard(SNAK..'ChekBotAdd') or 0)..'\n𖥔 عدد المشتركين : '..(Redis:scard(SNAK..'Num:User:Pv') or 0)..'*',"md",true)  
end
...
if Redis:sismember(SNAK.."ChekBotAdd",msg_chat_id) then
if tonumber(Info_Chats.member_count) < tonumber((Redis:get(SNAK..'Num:Add:Bot') or 0)) and not msg.ControllerBot then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد الاعضاء قليل لا يمكن تفعيل المجموعه  يجب ان يكوم اكثر من :'..Redis:get(SNAK..'Num:Add:Bot'),"md",true)  
end
...
Redis:sadd(SNAK.."ChekBotAdd",msg_chat_id)
Redis:set(SNAK.."Status:Id"..msg_chat_id,true) ;Redis:set(SNAK.."Status:Reply"..msg_chat_id,true) ;Redis:set(SNAK.."Status:ReplySudo"..msg_chat_id,true) ;Redis:set(SNAK.."Status:BanId"..msg_chat_id,true) ;Redis:set(SNAK.."Status:SetId"..msg_chat_id,true) 
...
if not Redis:get(SNAK.."BotFree") then
...
local Get_Chat = LuaTele.getChat(msg_chat_id)
local Info_Chats = LuaTele.getSupergroupFullInfo(msg_chat_id)
if not Redis:sismember(SNAK.."ChekBotAdd",msg_chat_id) then
...
Redis:srem(SNAK.."ChekBotAdd",msg_chat_id)
...
if chat_type(msg.chat_id) == "GroupBot" and Redis:sismember(SNAK.."ChekBotAdd",msg_chat_id) then
if text == "ايدي" or text =='id' or text =='Id' or text == 'ID' and msg.reply_to_message_id == 0 then
if not Redis:get(SNAK.."Status:Id"..msg_chat_id) then
return false
end
...
local TotalMsg = Redis:get(SNAK..'Num:Message:User'..msg_chat_id..':'..msg.sender.user_id) or 0
local TotalPhoto = photo.total_count or 0
local TotalEdit = Redis:get(SNAK..'Num:Message:Edit'..msg_chat_id..msg.sender.user_id) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumberGames = Redis:get(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
local NumAdd = Redis:get(SNAK.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0
...
Get_Is_Id = Redis:get(SNAK.."Set:Id:Groups") or Redis:get(SNAK.."Set:Id:Group"..msg_chat_id)
if Redis:get(SNAK.."Status:IdPhoto"..msg_chat_id) then
if Get_Is_Id then
...
local TotalMsg = Redis:get(SNAK..'Num:Message:User'..msg_chat_id..':'..UserId) or 0
local TotalEdit = Redis:get(SNAK..'Num:Message:Edit'..msg_chat_id..UserId) or 0
local TotalMsgT = Total_message(TotalMsg) 
local NumAdd = Redis:get(SNAK.."Num:Add:Memp"..msg.chat_id..":"..UserId) or 0
local NumberGames = Redis:get(SNAK.."Num:Add:Games"..msg.chat_id..UserId) or 0
if Get_Is_Id then
local Get_Is_Id = Get_Is_Id:gsub('#AddMem',NumAdd) 
...
Redis:set(SNAK.."allM:numdel"..msg.chat_id,Numbardel) 
...
local list = Redis:smembers(SNAK.."allM"..msg.chat_id)
for k,v in pairs(list) do
local Message = v
if Message then
...
local gmria = Redis:scard(SNAK.."allM"..msg.chat_id)  
...
Redis:del(SNAK.."Status:Del:Media"..msg.chat_id)
...
Redis:set(SNAK.."Status:Del:Media"..msg.chat_id,true)
...
local StatusMember = LuaTele.getChatMember(msg_chat_id,SNAK).status.luatele
if (StatusMember ~= "chatMemberStatusAdministrator") then
return LuaTele.sendText(msg_chat_id,msg_id,'𖥔 البوت عضو في الجروب ',"md",true) 
end
local GetMemberStatus = LuaTele.getChatMember(msg_chat_id,SNAK).status
if GetMemberStatus.can_change_info then
change_info = '❬ ✅ ❭' else change_info = '❬ ❎ ❭'
end
if GetMemberStatus.can_delete_messages then
...
if not Redis:sismember(SNAK.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(SNAK.."HELPBEVQ:Groups")
Redis:del(SNAK.."HELPBEVQ:Groups", bana.id)
Redis:del(SNAK.."id:HELPBEVQ:Groups", bana.id)
...
if not Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(SNAK.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Originators:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(SNAK.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Managers:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Addictive:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if not Redis:sismember(SNAK.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(SNAK.."HELPBEVQ:Groups")
Redis:del(SNAK.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:del(SNAK.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if not Redis:sismember(SNAK.."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."Developers:Groups",Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:srem(SNAK.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if not Redis:sismember(SNAK.."HELPBEVQ:Groups",UserId) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId,"𖥔 تم تنزيله مساعد مسبقا ").Reply,"md",true)  
else
Redis:del(SNAK.."HELPBEVQ:Groups")
Redis:del(SNAK.."HELPBEVQ:Groups", UserId)
Redis:del(SNAK.."id:HELPBEVQ:Groups", UserId)
...
if not Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله مالك مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المنشئين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المدراء مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من الادمنيه مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if not Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم تنزيله من المميزين مسبقا ").Reply,"md",true)  
else
Redis:srem(SNAK.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."HELPBEVQ:Groups",bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مطور ثانوي مسبقا ").Reply,"md",true)  
else
Redis:del(SNAK.."HELPBEVQ:Groups")
Redis:sadd(SNAK.."HELPBEVQ:Groups", UserId)
Redis:set(SNAK.."id:HELPBEVQ:Groups", UserId)
...
if Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."TheBasicsQ:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."TheBasics:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(SNAK.."Originators:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Originators:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(SNAK.."Managers:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Managers:Group"..msg_chat_id,bana.id) 
...
if not msg.Originators and not Redis:get(SNAK.."Status:SetId"..msg_chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تعطيل (الرفع) من قبل المنشئين","md",true)
end 
if Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Addictive:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id,bana.id) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(bana.id,"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Distinguished:Group"..msg_chat_id,bana.id) 
...
if Redis:sismember(SNAK.."DevelopersQ:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."DevelopersQ:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."HELPBEVQ:Groups",Message_Reply.sender.user_id) then
...
Redis:del(SNAK.."HELPBEVQ:Groups")
Redis:sadd(SNAK.."HELPBEVQ:Groups", Message_Reply.sender.user_id)
Redis:set(SNAK.."id:HELPBEVQ:Groups", Message_Reply.sender.user_id)
...
if Redis:sismember(SNAK.."Developers:Groups",Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."Developers:Groups",Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."TheBasicsQ:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."TheBasics:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."Originators:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."Managers:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."Addictive:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) then
...
Redis:sadd(SNAK.."Distinguished:Group"..msg_chat_id,Message_Reply.sender.user_id) 
...
if Redis:sismember(SNAK.."HELPBEVQ:Groups",UserId) then
...
if Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مالك مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."TheBasicsQ:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته منشئ اساسي مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."TheBasics:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Originators:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته منشئ  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Originators:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Managers:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مدير  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Managers:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته ادمن  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Addictive:Group"..msg_chat_id,UserId[2]) 
...
if Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id,UserId[2]) then
return LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(UserId[2],"𖥔 تم ترقيته مميز  مسبقا ").Reply,"md",true)  
else
Redis:sadd(SNAK.."Distinguished:Group"..msg_chat_id,UserId[2]) 
...
Redis:set(SNAK.."Developer:Bot:Reply"..msg.chat_id,Teext)
...
Redis:set(SNAK.."President:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(SNAK.."Constructor:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(SNAK.."PresidentQ:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(SNAK.."Manager:Group:Reply"..msg.chat_id,Teext) 
...
Redis:set(SNAK.."Admin:Group:Reply"..msg.chat_id,Teext)
...
Redis:set(SNAK.."Vip:Group:Reply"..msg.chat_id,Teext)
...
local Info_Members = Redis:smembers(SNAK.."DevelopersQ:Groups") 
...
local Info_Members = Redis:smembers(SNAK.."Developers:Groups") 
if #Info_Members == 0 then
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 لا يوجد مطورين حاليا , ","md",true)  
end
...
local Info_Members = Redis:smembers(SNAK.."TheBasicsQ:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."TheBasics:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Originators:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Managers:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Addictive:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."Distinguished:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."BanAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."ktmAll:Groups") 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."BanGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
local Info_Members = Redis:smembers(SNAK.."SilentGroup:Group"..msg_chat_id) 
if #Info_Members == 0 then
...
Redis:set(SNAK.."Status:Link"..msg_chat_id,true) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تفعيل الرابط ","md",true)
end
if TextMsg == 'الترحيب' then
Redis:set(SNAK.."Status:Welcome"..msg_chat_id,true) 
...
Redis:set(SNAK.."Status:IdPhoto"..msg_chat_id,true) 
...
Redis:set(SNAK.."Status:Reply"..msg_chat_id,true) 
...
Redis:set(SNAK.."Status:ReplySudo"..msg_chat_id,true) 
...
Redis:set(SNAK.."Status:BanId"..msg_chat_id,true) 
...
Redis:del(SNAK.."Status:Id"..msg_chat_id) 
...
Redis:del(SNAK.."Status:IdPhoto"..msg_chat_id) 
...
Redis:del(SNAK.."Status:Reply"..msg_chat_id) 
...
Redis:del(SNAK.."Status:ReplySudo"..msg_chat_id) 
...
Redis:del(SNAK.."Status:BanId"..msg_chat_id) 
...
if text == "نزلني" then
if not Redis:get(SNAK.."Status:remMe"..msg_chat_id) then
...
Rink = 1
elseif Redis:sismember(SNAK.."DevelopersQ:Groups",msg.sender.user_id)  then
Rink = 2
elseif Redis:sismember(SNAK.."Developers:Groups",msg.sender.user_id)  then
Rink = 3
elseif Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 4
elseif Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 5
elseif Redis:sismember(SNAK.."Originators:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 6
elseif Redis:sismember(SNAK.."Managers:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 7
elseif Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 8
elseif Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id, msg.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Redis:srem(SNAK.."Addictive:Group"..msg_chat_id, msg.sender.user_id)
Redis:srem(SNAK.."Distinguished:Group"..msg_chat_id, msg.sender.user_id)
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم تنزيلك من الادمنيه والمميزين ","md",true) 
end
end

if text == "اطردني" or text == "طردني" then
if not Redis:get(SNAK.."Status:KickMe"..msg_chat_id) then
...
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(SNAK.."TheBasics:Group"..msg_chat_id,v.member_id.user_id) 
x = x + 1
else
Redis:sadd(SNAK.."Addictive:Group"..msg_chat_id,v.member_id.user_id) 
y = y + 1
end
end
end
...
local TestText = "  ❲ Developers SNAK  ❳\n— — — — — — — — —\n 𖥔*Dev Name* :  [".. ban.first_name.."](tg://user?id="..Sudo_Id..")\n𖥔 *Dev Bio* : [❲ "..Bio.." ❳]"
local msg_id = msg.id/2097152/0.5 
...
if photo.total_count > 0 then
local TestText = "  ❲ SNAK  Source ❳\n— — — — — — — — —\n 𖥔*Dev Name* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n𖥔 *Dev Bio* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '< Developers SNAK  >', url = "https://t.me/Q_o_ll"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
local id = Redis:get(SNAK.."id:HELPBEVQ:Groups")
...
local Added_Me = Redis:get(SNAK.."Who:Added:Me"..msg.sender.user_id..':'..msg.sender.user_id)
if Added_Me then 
...
if not Redis:get(SNAK.."rb:bna"..msg_chat_id) then
...
if Redis:get(SNAK.."lockalllll"..msg_chat_id) == "off" then
...
Redis:sadd(SNAK.."cleaner"..msg_chat_id,msg_id)
end
if text == "مسح الميديا" then 
if not msg.Managers then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 هاذا الامر يخص⦗ '..Controller_Num(6)..' ⦘* ',"md",true)  
end
local list = Redis:smembers(SNAK.."cleaner"..msg_chat_id)
if #list == 0 then 
...
Redis:del(SNAK.."cleaner"..msg_chat_id)
...
---زخرفة ----
if Redis:get(SNAK.."zhrfa"..msg.sender.user_id) == "sendzh" then
...
LuaTele.sendText(msg_chat_id,msg_id,t,"md",true) 
Redis:del(SNAK.."zhrfa"..msg.sender.user_id) 
end



if text == "جمالي" or text == 'نسبه جمالي' then
if Redis:get(SNAK.."Status:gamle"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
...
if Redis:get(SNAK.."Status:kool"..msg.chat_id) then
return LuaTele.sendText(msg_chat_id,msg_id,m,"md",true) 
end
end
if text == "صورتي" then
if Redis:get(SNAK.."Status:photo"..msg.chat_id) then
local photo = LuaTele.getUserProfilePhotos(msg.sender.user_id)
local ban = LuaTele.getUser(msg.sender.user_id)
...
if not msg.ControllerBot and not Redis:set(SNAK.."LeftBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local chinfo = Redis:get(SNAK.."ch:admin")
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = chinfo}, },}}
return LuaTele.sendText(msg.chat_id,msg.id,'*\n𖥔 عليك الاشتراك في قناة البوت لاستخذام الاوامر*',"md",false, false, false, false, reply_markup)
end
local reply_markup = LuaTele.replyMarkup{
...
Redis:set(SNAK.."Lock:text"..msg_chat_id,true) 
...
Redis:set(SNAK.."Lock:AddMempar"..msg_chat_id,"kick")  
...
Redis:set(SNAK.."Lock:Join"..msg_chat_id,"kick")  
...
Redis:set(SNAK.."Lock:Bot:kick"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Bot:kick"..msg_chat_id,"kick")  
...
Redis:set(SNAK.."Lock:tagservr"..msg_chat_id,true)  
...
Redis:set(SNAK.."lockalllll"..msg_chat_id,"off")
...
Redis:set(SNAK.."lockalllll"..msg_chat_id,"on")
...
Redis:set(SNAK.."lockpin"..msg_chat_id,(LuaTele.getChatPinnedMessage(msg_chat_id).id or true)) 
...
Redis:set(SNAK.."Lock:edit"..msg_chat_id,true) 
...
Redis:set(SNAK.."Lock:tagservrbot"..msg_chat_id,true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(SNAK..''..lock..msg_chat_id,"del")    
end
...
Redis:del(SNAK.."Lock:AddMempar"..msg_chat_id)  
...
Redis:del(SNAK.."Lock:text"..msg_chat_id)  
...
Redis:del(SNAK.."Lock:Join"..msg_chat_id)  
...
Redis:del(SNAK.."Lock:Bot:kick"..msg_chat_id)  
...
Redis:del(SNAK.."Lock:tagservr"..msg_chat_id)  
...
Redis:del(SNAK.."lockpin"..msg_chat_id)  
...
Redis:del(SNAK.."Lock:edit"..msg_chat_id) 
...
Redis:del(SNAK.."Lock:tagservrbot"..msg_chat_id)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(SNAK..''..lock..msg_chat_id)    
end
...
Redis:hset(SNAK.."Spam:Group:User"..msg_chat_id ,"Spam:User","del")  
...
Redis:hset(SNAK.."Spam:Group:User"..msg_chat_id ,"Spam:User","keed")  
...
Redis:hset(SNAK.."Spam:Group:User"..msg_chat_id ,"Spam:User","mute")  
...
Redis:hset(SNAK.."Spam:Group:User"..msg_chat_id ,"Spam:User","kick")  
...
Redis:hdel(SNAK.."Spam:Group:User"..msg_chat_id ,"Spam:User")  
...
Redis:set(SNAK.."Lock:Link"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Link"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Link"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Link"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Link"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:User:Name"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:User:Name"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:User:Name"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:User:Name"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:User:Name"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:hashtak"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:hashtak"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:hashtak"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:hashtak"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:hashtak"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Cmd"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Cmd"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Cmd"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Cmd"..msg_chat_id,"kick")  
...
Redis:set(SNAK..'lock:Fshar'..msg.chat_id,true) 
...
Redis:set(SNAK..'lock:Cht'..msg.chat_id,true) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم قفـل السب").Lock,"md",true)  
end
...
Redis:set(SNAK..'lock:Fars'..msg.chat_id,true) 
...
Redis:del(SNAK..'lock:Fshar'..msg.chat_id) 
...
Redis:del(SNAK..'lock:Cht'..msg.chat_id) 
LuaTele.sendText(msg_chat_id,msg_id,Reply_Status(msg.sender.user_id,"𖥔 تم فتح السب").unLock,"md",true)  
end
...
Redis:del(SNAK..'lock:Fars'..msg.chat_id) 
...
Redis:del(SNAK.."Lock:Cmd"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Photo"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Photo"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Photo"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Photo"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Photo"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Video"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Video"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Video"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Video"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Video"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Animation"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Animation"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Animation"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Animation"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Animation"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:geam"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:geam"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:geam"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:geam"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:geam"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Audio"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Audio"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Audio"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Audio"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Audio"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:vico"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:vico"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:vico"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:vico"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:vico"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Keyboard"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Keyboard"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Keyboard"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Keyboard"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Keyboard"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Sticker"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Sticker"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Sticker"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Sticker"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Sticker"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:forward"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:forward"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:forward"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:forward"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:forward"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Document"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Document"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Document"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Document"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Document"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Unsupported"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Unsupported"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Unsupported"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Unsupported"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Unsupported"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Markdaun"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Markdaun"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Markdaun"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Markdaun"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Markdaun"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Contact"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Contact"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Contact"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Contact"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Contact"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Spam"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Spam"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Spam"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Spam"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Spam"..msg_chat_id)  
...
Redis:set(SNAK.."Lock:Inlen"..msg_chat_id,"del")  
...
Redis:set(SNAK.."Lock:Inlen"..msg_chat_id,"ked")  
...
Redis:set(SNAK.."Lock:Inlen"..msg_chat_id,"ktm")  
...
Redis:set(SNAK.."Lock:Inlen"..msg_chat_id,"kick")  
...
Redis:del(SNAK.."Lock:Inlen"..msg_chat_id)  
...
Redis:setex(SNAK.."Set:Link"..msg_chat_id..""..msg.sender.user_id,120,true) 
...
Redis:setex(SNAK.."Tshake:Welcome:Group" .. msg_chat_id .. "" .. msg.sender.user_id, 120, true)  
...
if not Redis:get(SNAK.."Status:Welcome"..msg_chat_id) then
...
Redis:del(SNAK.."Welcome:Group"..msg_chat_id) 
...
Redis:setex(SNAK.."Set:Rules:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:del(SNAK.."Group:Rules"..msg_chat_id) 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 تم ازالة قوانين الجروب","md",true)    
end
if text == "القوانين" then 
local Rules = Redis:get(SNAK.."Group:Rules" .. msg_chat_id)   
if Rules then     
...
Redis:setex(SNAK.."Set:Description:" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:set(SNAK.."Chat:Photo"..msg_chat_id..":"..msg.sender.user_id,true) 
...
local list = Redis:smembers(SNAK.."List:Filter"..msg_chat_id)  
if #list == 0 then  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
Redis:del(SNAK.."Filter:Group:"..v..msg_chat_id)  
Redis:srem(SNAK.."List:Filter"..msg_chat_id,v)  
end  
...
v = v:gsub('animation:',"") 
v = v:gsub('text:',"") 
local Text_Filter = Redis:get(SNAK.."Filter:Group:"..v..msg_chat_id)   
...
Redis:set(SNAK..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'true')
...
Redis:set(SNAK..'FilterText'..msg_chat_id..':'..msg.sender.user_id,'DelFilter')
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 ارسل الان { ملصق ,متحركه ,صوره ,رساله } *',"md",true)  
end
...
Redis:set(SNAK.."All:Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
Redis:set(SNAK.."All:Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
...
local list = Redis:smembers(SNAK.."All:Command:List:Group")
for k,v in pairs(list) do
Redis:del(SNAK.."All:Get:Reides:Commands:Group"..v)
Redis:del(SNAK.."All:Command:List:Group")
end
...
for k,v in pairs(list) do
Commands = Redis:get(SNAK.."All:Get:Reides:Commands:Group"..v)
if Commands then 
...
Redis:set(SNAK.."Command:Reids:Group"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 الان ارسل لي الامر القديم ...","md",true)
end
...
Redis:set(SNAK.."Command:Reids:Group:Del"..msg_chat_id..":"..msg.sender.user_id,"true") 
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الان الامر الذي قمت بوضعه مكان الامر القديم","md",true)
end
...
local list = Redis:smembers(SNAK.."Command:List:Group"..msg_chat_id)
for k,v in pairs(list) do
Redis:del(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
Redis:del(SNAK.."Command:List:Group"..msg_chat_id)
end
...
for k,v in pairs(list) do
Commands = Redis:get(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..v)
if Commands then 
Command = Command..""..k..": ("..v..") ← {"..Commands.."}\n"
else
Command = Command..""..k..": ("..v..") \n"
...
{
{text = 'اتعطيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:bna_ban'},{text = 'اتفعيل ردود السورس', data = msg.sender.user_id..'/'.. 'rb:bna_SNAK'},
},
{
...
if Redis:get(SNAK.."Status:Link"..msg.chat_id) then
Statuslink = '❬ ✅ ❭' else Statuslink = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:Welcome"..msg.chat_id) then
StatusWelcome = '❬ ✅ ❭' else StatusWelcome = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:Id"..msg.chat_id) then
StatusId = '❬ ✅ ❭' else StatusId = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:IdPhoto"..msg.chat_id) then
StatusIdPhoto = '❬ ✅ ❭' else StatusIdPhoto = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:Reply"..msg.chat_id) then
StatusReply = '❬ ✅ ❭' else StatusReply = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:ReplySudo"..msg.chat_id) then
StatusReplySudo = '❬ ✅ ❭' else StatusReplySudo = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:BanId"..msg.chat_id)  then
StatusBanId = '❬ ✅ ❭' else StatusBanId = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:SetId"..msg.chat_id) then
StatusSetId = '❬ ✅ ❭' else StatusSetId = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
StatusGames = '❬ ✅ ❭' else StatusGames = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:KickMe"..msg.chat_id) then
Statuskickme = '❬ ✅ ❭' else Statuskickme = '❬ ❎ ❭'
end
if Redis:get(SNAK.."Status:AddMe"..msg.chat_id) then
...
Rink = 1
elseif Redis:sismember(SNAK.."DevelopersQ:Groups",Message_Reply.sender.user_id)  then
Rink = 2
elseif Redis:sismember(SNAK.."Developers:Groups",Message_Reply.sender.user_id)  then
Rink = 3
elseif Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 4
elseif Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 5
elseif Redis:sismember(SNAK.."Originators:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 6
elseif Redis:sismember(SNAK.."Managers:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 7
elseif Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 8
elseif Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id, Message_Reply.sender.user_id) then
Rink = 9
else
Rink = 10
end
...
Rink = 1
elseif Redis:sismember(SNAK.."DevelopersQ:Groups",bana.id)  then
Rink = 2
elseif Redis:sismember(SNAK.."Developers:Groups",bana.id)  then
Rink = 3
elseif Redis:sismember(SNAK.."TheBasicsQ:Group"..msg_chat_id, bana.id) then
Rink = 4
elseif Redis:sismember(SNAK.."TheBasics:Group"..msg_chat_id, bana.id) then
Rink = 5
elseif Redis:sismember(SNAK.."Originators:Group"..msg_chat_id, bana.id) then
Rink = 6
elseif Redis:sismember(SNAK.."Managers:Group"..msg_chat_id, bana.id) then
Rink = 7
elseif Redis:sismember(SNAK.."Addictive:Group"..msg_chat_id, bana.id) then
Rink = 8
elseif Redis:sismember(SNAK.."Distinguished:Group"..msg_chat_id, bana.id) then
Rink = 9
else
Rink = 10
end
...
Redis:del(SNAK..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع رسائلك ',"md",true)  
elseif text == 'مسح سحكاتي' or text == 'مسح تعديلاتي' then
Redis:del(SNAK..'Num:Message:Edit'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع تعديلاتك ',"md",true)  
elseif text == 'مسح جهاتي' then
Redis:del(SNAK..'Num:Add:Memp'..msg.chat_id..':'..msg.sender.user_id)
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 تم مسح جميع جهاتك المضافه ',"md",true)  
elseif text == 'رسائلي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد رسائلك هنا *~ '..(Redis:get(SNAK..'Num:Message:User'..msg.chat_id..':'..msg.sender.user_id) or 1)..'*',"md",true)  
elseif text == 'سحكاتي' or text == 'تعديلاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد التعديلات هنا *~ '..(Redis:get(SNAK..'Num:Message:Edit'..msg.chat_id..msg.sender.user_id) or 0)..'*',"md",true)  
elseif text == 'جهاتي' then
LuaTele.sendText(msg_chat_id,msg_id,'𖥔 عدد جهاتك المضافه هنا *~ '..(Redis:get(SNAK.."Num:Add:Memp"..msg.chat_id..":"..msg.sender.user_id) or 0)..'*',"md",true)  
...
Redis:setex(SNAK.."Redis:Id:Groups"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
...
Redis:setex(SNAK.."Redis:Id:Group"..msg.chat_id..""..msg.sender.user_id,240,true)  
return LuaTele.sendText(msg_chat_id,msg_id,[[
𖥔 ارسل الان النص
𖥔 يمكنك اضافه :
𖥔 `#username` » اسم المستخدم
...
Redis:del(SNAK.."Set:Id:Group"..msg.chat_id)
...
Redis:del(SNAK.."DevelopersQ:Groups") 
...
Redis:del(SNAK.."Developers:Groups") 
...
Redis:del(SNAK.."TheBasics:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Originators:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Managers:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Addictive:Group"..msg_chat_id) 
...
Redis:del(SNAK.."Distinguished:Group"..msg_chat_id) 
...
Redis:del(SNAK.."BanGroup:Group"..msg_chat_id) 
...
Redis:del(SNAK.."SilentGroup:Group"..msg_chat_id) 
...
local list = Redis:smembers(SNAK.."List:Manager"..msg_chat_id.."")
for k,v in pairs(list) do
Redis:del(SNAK.."Add:Rd:Manager:Gif"..v..msg_chat_id)   
Redis:del(SNAK.."Add:Rd:Manager:Vico"..v..msg_chat_id)   
Redis:del(SNAK.."Add:Rd:Manager:Stekrs"..v..msg_chat_id)     
Redis:del(SNAK.."Add:Rd:Manager:Text"..v..msg_chat_id)   
Redis:del(SNAK.."Add:Rd:Manager:Photo"..v..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Video"..v..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:File"..v..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:video_note"..v..msg_chat_id)
Redis:del(SNAK.."Add:Rd:Manager:Audio"..v..msg_chat_id)
Redis:del(SNAK.."List:Manager"..msg_chat_id)
end
...
text = "𖥔 قائمه الردود \n⩹━━━━𖥕SNAK𖥕━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(SNAK.."Add:Rd:Manager:Gif"..v..msg_chat_id) then
db = "متحركه 🎭"
elseif Redis:get(SNAK.."Add:Rd:Manager:Vico"..v..msg_chat_id) then
db = "بصمه 📢"
elseif Redis:get(SNAK.."Add:Rd:Manager:Stekrs"..v..msg_chat_id) then
db = "ملصق 🃏"
elseif Redis:get(SNAK.."Add:Rd:Manager:Text"..v..msg_chat_id) then
db = "رساله ✉"
elseif Redis:get(SNAK.."Add:Rd:Manager:Photo"..v..msg_chat_id) then
db = "صوره 🎇"
elseif Redis:get(SNAK.."Add:Rd:Manager:Video"..v..msg_chat_id) then
db = "فيديو 📹"
elseif Redis:get(SNAK.."Add:Rd:Manager:File"..v..msg_chat_id) then
db = "ملف 𖥔"
elseif Redis:get(SNAK.."Add:Rd:Manager:Audio"..v..msg_chat_id) then
db = "اغنيه 🎵"
elseif Redis:get(SNAK.."Add:Rd:Manager:video_note"..v..msg_chat_id) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(SNAK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(SNAK.."Set:Manager:rd"..msg.sender.user_id..":"..msg_chat_id,"true2")
return LuaTele.sendText(msg_chat_id,msg_id,"𖥔 ارسل الان الكلمه لحذفها من الردود","md",true)  
end
if text and not Redis:sismember(SNAK.."Spam:Group"..msg.sender.user_id,text) then
Redis:del(SNAK.."Spam:Group"..msg.sender.user_id) 
end
...
local list = Redis:smembers(SNAK.."List:Rd:Sudo")
for k,v in pairs(list) do
Redis:del(SNAK.."Add:Rd:Sudo:Gif"..v)   
Redis:del(SNAK.."Add:Rd:Sudo:vico"..v)   
Redis:del(SNAK.."Add:Rd:Sudo:stekr"..v)     
Redis:del(SNAK.."Add:Rd:Sudo:Text"..v)   
Redis:del(SNAK.."Add:Rd:Sudo:Photoc"..v)
Redis:del(SNAK.."Add:Rd:Sudo:Photo"..v)
Redis:del(SNAK.."Add:Rd:Sudo:Video"..v)
Redis:del(SNAK.."Add:Rd:Sudo:File"..v)
Redis:del(SNAK.."Add:Rd:Sudo:Audio"..v)
Redis:del(SNAK.."Add:Rd:Sudo:video_note"..v)
Redis:del(SNAK.."List:Rd:Sudo")
end
...
text = "\n📝︙قائمة الردود العامه \n⩹━━━━𖥕SNAK𖥕━━━━⩺\n"
for k,v in pairs(list) do
if Redis:get(SNAK.."Add:Rd:Sudo:Gif"..v) then
db = "متحركه 🎭"
elseif Redis:get(SNAK.."Add:Rd:Sudo:vico"..v) then
db = "بصمه 📢"
elseif Redis:get(SNAK.."Add:Rd:Sudo:stekr"..v) then
db = "ملصق 🃏"
elseif Redis:get(SNAK.."Add:Rd:Sudo:Text"..v) then
db = "رساله ✉"
elseif Redis:get(SNAK.."Add:Rd:Sudo:Photo"..v) then
db = "صوره 🎇"
elseif Redis:get(SNAK.."Add:Rd:Sudo:Video"..v) then
db = "فيديو 📹"
elseif Redis:get(SNAK.."Add:Rd:Sudo:File"..v) then
db = "ملف 𖥔"
elseif Redis:get(SNAK.."Add:Rd:Sudo:Audio"..v) then
db = "اغنيه 🎵"
elseif Redis:get(SNAK.."Add:Rd:Sudo:video_note"..v) then
db = "بصمه فيديو 🎥"
end
text = text..""..k.." » {"..v.."} » {"..db.."}\n"
end
...
Redis:set(SNAK.."Set:Rd"..msg.sender.user_id..":"..msg_chat_id,true)
...
Redis:set(SNAK.."Set:On"..msg.sender.user_id..":"..msg_chat_id,true)
...
if not msg.ControllerBot and not Redis:set(SNAK.."SendBcBot") then
return LuaTele.sendText(msg_chat_id,msg_id,'\n*𖥔 امر المغادره معطل من قبل الاساسي ',"md",true)  
end
if ChannelJoin(msg) == false then
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = 'اضغط للاشتراك', url = 't.me/'..Redis:get(SNAK..'Channel:Join')}, },}}
...
Redis:setex(SNAK.."Broadcasting:Users" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(SNAK.."Broadcasting:Groups" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(SNAK.."Broadcasting:Groups:Pin" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
LuaTele.sendText(msg_chat_id,msg_id,[[
↯︙ارسل لي سواء كان 
❨ ملف • ملصق • متحركه • صوره
 • فيديو • بصمه الفيديو • بصمه • صوت • رساله ❩
...
Redis:setex(SNAK.."Broadcasting:Groups:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
Redis:setex(SNAK.."Broadcasting:Users:Fwd" .. msg_chat_id .. ":" .. msg.sender.user_id, 600, true) 
...
BanAll = 'محظور عام ,'
Redis:srem(SNAK.."BanAll:Groups",Message_Reply.sender.user_id) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).BanGroup == true then
BanGroup = 'محظور ,'
Redis:srem(SNAK.."BanGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
BanGroup = ''
end
if Statusrestricted(msg_chat_id,Message_Reply.sender.user_id).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(SNAK.."SilentGroup:Group"..msg_chat_id,Message_Reply.sender.user_id) 
else
SilentGroup = ''
end
...
BanAll = 'محظور عام ,'
Redis:srem(SNAK.."BanAll:Groups",bana.id) 
else
BanAll = ''
end
if Statusrestricted(msg_chat_id,bana.id).BanGroup == true then
...
if Statusrestricted(msg_chat_id,bana.id).SilentGroup == true then
SilentGroup = 'مكتوم ,'
Redis:srem(SNAK.."SilentGroup:Group"..msg_chat_id,bana.id) 
else
SilentGroup = ''
end
LuaTele.sendText(msg_chat_id,msg_id,"\n*𖥔 تم رفع القيود عنه : {"..BanAll..BanGroup..SilentGroup..Restricted..'}*',"md",true)  
...
Redis:set(SNAK..'GetTexting:DevSNAK'..msg_chat_id..':'..msg.sender.user_id,true)
...
Redis:setex(SNAK.."Change:Name:Bot"..msg.sender.user_id,300,true) 
...
local ban = LuaTele.getUser(SNAK)
local Namebot = (Redis:get(SNAK.."Name:Bot") or "كلير")
local BotName = {
...
if text == (Redis:get(SNAK.."Name:Bot") or "كلير") then
local photo = LuaTele.getUserProfilePhotos(SNAK)
local ban = LuaTele.getUser(SNAK)
local Namebot = (Redis:get(SNAK.."Name:Bot") or "كلير")
local BotName = {
...
local Get_Chat = LuaTele.getChat(v)
if Get_Chat.id then
local statusMem = LuaTele.getChatMember(Get_Chat.id,SNAK)
if statusMem.status.luatele == "chatMemberStatusMember" then
x = x + 1
LuaTele.sendText(Get_Chat.id,0,'*𖥔 البوت عظو في الجروب سوف اغادر ويمكنك تفعيلي مره اخره *',"md")
Redis:srem(SNAK..'ChekBotAdd',Get_Chat.id)
local keys = Redis:keys(SNAK..'*'..Get_Chat.id)
for i = 1, #keys do
Redis:del(keys[i])
end
...
x = x + 1
local keys = Redis:keys(SNAK..'*'..v)
for i = 1, #keys do
Redis:del(keys[i])
end
Redis:srem(SNAK..'ChekBotAdd',v)
LuaTele.leaveChat(v)
end
end
if x ~= 0 then
...
Redis:set(SNAK.."Game:Smile"..msg.chat_id,SM)
...
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
Redis:del(SNAK.."Set:Country"..msg.chat_id)
...
Redis:set(SNAK.."Game:Countrygof"..msg.chat_id,name)
...
Redis:set(SNAK.."Game:Monotonous"..msg.chat_id,name)
...
Redis:set(SNAK.."Game:Riddles"..msg.chat_id,name)
...
if text == "معاني" then
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
Redis:del(SNAK.."Set:Maany"..msg.chat_id)
Maany_Rand = {"قرد","دجاجه","بطريق","ضفدع","بومه","نحله","ديك","جمل","بقره","دولفين","تمساح","قرش","نمر","اخطبوط","سمكه","خفاش","اسد","فأر","ذئب","فراشه","عقرب","زرافه","قنفذ","تفاحه","باذنجان"}
name = Maany_Rand[math.random(#Maany_Rand)]
Redis:set(SNAK.."Game:Meaningof"..msg.chat_id,name)
...
if text == "العكس" then
if Redis:get(SNAK.."Status:Games"..msg.chat_id) then
Redis:del(SNAK.."Set:Aks"..msg.chat_id)
katu = {"باي","فهمت","موزين","اسمعك","احبك","موحلو","نضيف","حاره","ناصي","جوه","سريع","ونسه","طويل","سمين","ضعيف","شريف","شجاع","رحت","عدل","نشيط","شبعان","موعطشان","خوش ولد","اني","هادئ"}
name = katu[math.random(#katu)]
Redis:set(SNAK.."Game:Reflection"..msg.chat_id,name)
...
Redis:set(SNAK.."Game:Estimate"..msg.chat_id..msg.sender.user_id,Num)  
...
Redis:set(SNAK.."Game:Difference"..msg.chat_id,name)
...
Redis:set(SNAK.."Game:Example"..msg.chat_id,name)
...
local NumberGame = Redis:get(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id)
...
Redis:decrby(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id,NumGame)  
Redis:incrby(SNAK.."Num:Message:User"..msg.chat_id..":"..msg.sender.user_id,NumGame)  
...
Redis:incrby(SNAK.."Num:Add:Games"..msg.chat_id..Message_Reply.sender.user_id, text:match("^اضف مجوهرات (%d+)$"))  
...
Redis:incrby(SNAK.."Num:Message:User"..msg.chat_id..":"..Message_Reply.sender.user_id, text:match("^اضف رسائل (%d+)$"))  
...
local Num = Redis:get(SNAK.."Num:Add:Games"..msg.chat_id..msg.sender.user_id) or 0
if Num == 0 then 
...
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(SNAK.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
local ban = LuaTele.getUser(SNAK)
local bain = LuaTele.getUser(msg.sender.user_id)
Redis:sadd(SNAK..'Num:User:Pv',msg.sender.user_id)  
if not msg.ControllerBot then
if not Redis:get(SNAK.."Start:Bot") then
...
local CmdStart = '*\n𖥔 أهلآ بك في بوت '..(Redis:get(SNAK.."Name:Bot") or "كلير")..
...
return LuaTele.sendText(msg_chat_id,msg_id,Redis:get(SNAK.."Start:Bot"),"md",false, false, false, false, reply_markup)
end
end
else
...
keyboardd.inline_keyboard = {
{
{text = '< Developers SNAK  >', url = "https://t.me/M_P_L_6"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = '< Developers SNAK  >', url = "https://t.me/BoOdY_BaSha"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
Redis:setex(SNAK.."Change:Start:Bot"..msg.sender.user_id,300,true) 
...
if not msg.ControllerBot then
if Redis:get(SNAK.."TwaslBot") and not Redis:sismember(SNAK.."BaN:In:Tuasl",msg.sender.user_id) then
local ListGet = {Sudo_Id,msg.sender.user_id}
local IdSudo = LuaTele.getChat(ListGet[1]).id
local IdUser = LuaTele.getChat(ListGet[2]).id
local FedMsg = LuaTele.sendForwarded(IdSudo, 0, IdUser, msg_id)
Redis:setex(SNAK.."Twasl:UserId"..msg.date,172800,IdUser)
...
Redis:srem(SNAK.."ChekBotAdd",'-100'..data.supergroup.id)
local keys = Redis:keys(SNAK..'*'..'-100'..data.supergroup.id..'*')
Redis:del(SNAK.."List:Manager"..'-100'..data.supergroup.id)
Redis:del(SNAK.."Command:List:Group"..'-100'..data.supergroup.id)
for i = 1, #keys do 
Redis:del(keys[i])
end
...
if msg.content.video_note then
if msg.content.video_note.video.remote.id == Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.photo then
if msg.content.photo.sizes[1].photo.remote.id then
idPhoto = msg.content.photo.sizes[1].photo.remote.id
...
if idPhoto == Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.sticker then 
if msg.content.sticker.sticker.remote.id == Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.voice_note then 
if msg.content.voice_note.voice.remote.id == Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.video then 
if msg.content.video.video.remote.id == Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.animation then 
if msg.content.animation.animation.remote.id ==  Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.document then
if msg.content.document.document.remote.id == Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
elseif msg.content.audio then
if msg.content.audio.audio.remote.id == Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
elseif text then
if text == Redis:get(SNAK.."PinMsegees:"..msg.chat_id) then
LuaTele.pinChatMessage(msg.chat_id,msg.id,true)
Redis:del(SNAK.."PinMsegees:"..msg.chat_id)
end
end
...
if Redis:get(SNAK.."Lock:tagservr"..data.message.chat_id) then
LuaTele.deleteMessages(data.message.chat_id,{[1]= data.message.id})
end
end 
if tonumber(data.message.sender.user_id) == tonumber(SNAK) then
return false
end
if data.message.content.luatele == "messageChatJoinByLink" and Redis:get(SNAK..'Status:joinet'..data.message.chat_id) == 'true' then
    local reply_markup = LuaTele.replyMarkup{
    type = 'inline',
    data = {
    {
...
if Message_Edit.sender.user_id == SNAK then
print('This is Edit for Bot')
return false
end
File_Bot_Run(Message_Edit,Message_Edit)
Redis:incr(SNAK..'Num:Message:Edit'..data.chat_id..Message_Edit.sender.user_id)
if Message_Edit.content.luatele == "messageContact" or Message_Edit.content.luatele == "messageVideoNote" or Message_Edit.content.luatele == "messageDocument" or Message_Edit.content.luatele == "messageAudio" or Message_Edit.content.luatele == "messageVideo" or Message_Edit.content.luatele == "messageVoiceNote" or Message_Edit.content.luatele == "messageAnimation" or Message_Edit.content.luatele == "messagePhoto" then
if Redis:get(SNAK.."Lock:edit"..data.chat_id) then
...
Redis:incrby(SNAK.."Num:Add:Games"..ChatId..IdUser, 1)  
...
Redis:set(SNAK.."zhrfa"..IdUser,"sendzh") 
end 
if Text == '/leftz@' then
LuaTele.editMessageText(ChatId,Msg_id,"*𖥔 ارسل الكلمه لزخرفتها عربي او انجلش*","md",true) 
Redis:set(SNAK.."zhrfa"..IdUser,"sendzh") 
...
Redis:set(SNAK.."rank_tf"..IdUser,"rank_tk") 
end
end 
...
Redis:set(SNAK.."AddSudosNew"..ChatId,true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."AddSudosNew"..ChatId)
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Link"..ChatId,"del")  
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Spam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Keyboard"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:vico"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Animation"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Document"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Video"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Photo"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:User:Name"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:hashtak"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Bot:kick"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:forward"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Audio"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Sticker"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Contact"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Join"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:AddMempar"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Unsupported"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."lockpin"..ChatId,(LuaTele.getChatPinnedMessage(ChatId).id or true)) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:tagservr"..ChatId,true)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Markdaun"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:edit"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:geam"..ChatId,"del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(SNAK.."Spam:Group:User"..ChatId ,"Spam:User","del")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Link"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Spam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Keyboard"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:vico"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Animation"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Document"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Video"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Photo"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:User:Name"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:hashtak"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:forward"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Audio"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Sticker"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Contact"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Unsupported"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Markdaun"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:geam"..ChatId,"ked")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(SNAK.."Spam:Group:User"..ChatId ,"Spam:User","keed")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Link"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Spam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Keyboard"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:vico"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Animation"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Document"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Video"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Photo"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:User:Name"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:hashtak"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:forward"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Audio"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Sticker"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Contact"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Unsupported"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Markdaun"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:geam"..ChatId,"ktm")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(SNAK.."Spam:Group:User"..ChatId ,"Spam:User","mute")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Link"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Spam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Keyboard"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:vico"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Animation"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Document"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Video"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Photo"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:User:Name"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:hashtak"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:forward"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Audio"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Sticker"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Contact"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Unsupported"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:Markdaun"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Lock:geam"..ChatId,"kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hset(SNAK.."Spam:Group:User"..ChatId ,"Spam:User","kick")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:Link"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:Welcome"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:Id"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:IdPhoto"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:Reply"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:ReplySudo"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:SetId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:BanId"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:Games"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Status:KickMe"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:Link"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:Welcome"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:Id"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:IdPhoto"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:Reply"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:ReplySudo"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:SetId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:BanId"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:Games"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تفعيل امر الالعاب").unLock, 'md', true, false, reply_markup)
end
elseif Text and Text:match('(%d+)/rb:bna_SNAK') then
local UserId = Text:match('(%d+)/rb:bna_SNAK')
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."rb:bna"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:set(SNAK.."Status:KickMe"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'listallAddorrem'},},}}
LuaTele.editMessageText(ChatId,Msg_id,Reply_Status(IdUser,"𖥔 تم تفعيل امر اطردني").unLock, 'md', true, false, reply_markup)
end
end
...
if Info_Members.members[k].bot_info == nil then
if Info_Members.members[k].status.luatele == "chatMemberStatusCreator" then
Redis:sadd(SNAK.."TheBasics:Group"..UserId[2],v.member_id.user_id) 
x = x + 1
else
Redis:sadd(SNAK.."Addictive:Group"..UserId[2],v.member_id.user_id) 
y = y + 1
end
end
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:set(SNAK.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:set(SNAK..''..lock..UserId[2],"del")    
end
...
if tonumber(IdUser) == tonumber(UserId[1]) then
Redis:del(SNAK.."Lock:tagservrbot"..UserId[2],true)   
list ={"Lock:Bot:kick","Lock:User:Name","Lock:hashtak","Lock:Cmd","Lock:Link","Lock:forward","Lock:Keyboard","Lock:geam","Lock:Photo","Lock:Animation","Lock:Video","Lock:Audio","Lock:vico","Lock:Sticker","Lock:Document","Lock:Unsupported","Lock:Markdaun","Lock:Contact","Lock:Spam"}
for i,lock in pairs(list) do 
Redis:del(SNAK..''..lock..UserId[2],"del")    
end
LuaTele.answerCallbackQuery(data.id, "𖥔 تم قفل جميع الاوامر بنجاح  ", true)
end
end
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Link"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Spam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Keyboard"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:vico"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Animation"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Document"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:text"..ChatId,true) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Video"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Photo"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:User:Name"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:hashtak"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Bot:kick"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:forward"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Audio"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Sticker"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Contact"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Join"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:AddMempar"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Unsupported"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:tagservr"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:Markdaun"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:edit"..ChatId) 
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Lock:geam"..ChatId)  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:hdel(SNAK.."Spam:Group:User"..ChatId ,"Spam:User")  
local reply_markup = LuaTele.replyMarkup{type = 'inline',data = {{{text = ': رجوع ➡️ .', data =UserId..'/'.. 'NoNextSeting'},},}}
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."TheBasics:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."TheBasicsQ:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Originators:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Managers:Group"..ChatId) 
...
if tonumber(IdUser) == tonumber(UserId) then
Redis:del(SNAK.."Addictive:Group"..ChatId) 
